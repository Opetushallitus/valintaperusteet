...
public enum Funktionimi {
    ...
    HAEMAKSIMIAMMATILLISISTATUTKINNOISTA(Funktiotyyppi.LUKUARVOFUNKTIO, Laskentamoodi.VALINTALASKENTA, Laskentamoodi.VALINTAKOELASKENTA),
    HAEUSEANTUTKINNONAMMATILLINENYTOARVOSANA(Funktiotyyppi.LUKUARVOFUNKTIO, Laskentamoodi.VALINTALASKENTA, Laskentamoodi.VALINTAKOELASKENTA);
