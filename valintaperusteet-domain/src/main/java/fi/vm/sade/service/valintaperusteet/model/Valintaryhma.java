...
public class Valintaryhma extends BaseEntity {
  ...
  @JoinTable(
      ...
      joinColumns =
          @JoinColumn(name = "valintaryhma_id", referencedColumnName = BaseEntity.ID_COLUMN_NAME),
      inverseJoinColumns =
          @JoinColumn(name = "hakukohdekoodi_id", referencedColumnName = BaseEntity.ID_COLUMN_NAME),
      uniqueConstraints =
          @UniqueConstraint(
              name = "UK_valintaryhma_hakukohdekoodi_001",
              columnNames = {"valintaryhma_id", "hakukohdekoodi_id"}))
  @ManyToMany(fetch = FetchType.LAZY)
  private Set<Hakukohdekoodi> hakukohdekoodit = new HashSet<Hakukohdekoodi>();

  @JoinTable(
      name = "valintaryhma_valintakoekoodi",
      joinColumns =
          @JoinColumn(name = "valintaryhma_id", referencedColumnName = BaseEntity.ID_COLUMN_NAME),
      inverseJoinColumns =
          @JoinColumn(
  ...
  @JoinTable(
      ...
      joinColumns =
          @JoinColumn(name = "valintaryhma_id", referencedColumnName = BaseEntity.ID_COLUMN_NAME),
      inverseJoinColumns =
          @JoinColumn(name = "organisaatio_id", referencedColumnName = BaseEntity.ID_COLUMN_NAME))
  @ManyToMany(fetch = FetchType.LAZY)
