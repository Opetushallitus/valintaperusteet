...
public class LaskentakaavaDAOTest {
	...
	public void testGetLaskentakaava() {
		...
		assertEquals(id, new Long(laskentakaava.getId()));
		assertEquals(Funktionimi.MAKSIMI, laskentakaava.getFunktiokutsu()
				.getFunktionimi());
	}
	...
	public void testInsert() {
		...
		Laskentakaava haettu = laskentakaavaDAO.getLaskentakaava(tallennettu
				.getId());
	...
	public void testFindAvaimet() throws Exception {
		...
		oids.add("3201");
		oids.add("oid6");
		List<Tuple> avaimet = laskentakaavaDAO
				.findLaskentakaavatByHakukohde(oids);
	...
	public void testLaskentakaavatRootLevel() {
		List<Laskentakaava> kaavas = laskentakaavaDAO.findKaavas(true, null,
				null, null);
	...
	public void testLaskentakaavatForValintaryhma() {
		List<Laskentakaava> kaavas = laskentakaavaDAO.findKaavas(true, "oid1",
				null, null);
	...
	public void testLaskentakaavatByTyyppi() {
		List<Laskentakaava> kaavas = laskentakaavaDAO.findKaavas(true, null,
				null, Funktiotyyppi.LUKUARVOFUNKTIO);
		assertEquals(22, kaavas.size());
		kaavas = laskentakaavaDAO.findKaavas(true, null, null,
