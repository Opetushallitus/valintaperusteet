...
//
//            List<ValinnanVaihe> vr8Lvaiheet = hakijaryhmaService.findByValintaryhma(vr8L.getOid());
...
//            List<ValinnanVaihe> hk7Lvaiheet = hakijaryhmaService.findByHakukohde(hk7L.getOid());
...
//
//            List<ValinnanVaihe> vr9Lvaiheet = hakijaryhmaService.findByValintaryhma(vr9L.getOid());
...
//            List<ValinnanVaihe> hk8Lvaiheet = hakijaryhmaService.findByHakukohde(hk8L.getOid());
...
//
//            List<ValinnanVaihe> vr11Lvaiheet = hakijaryhmaService.findByValintaryhma(vr11L.getOid());
...
//            List<ValinnanVaihe> vr10Lvaiheet = hakijaryhmaService.findByValintaryhma(vr10L.getOid());
...
//
//        final ValinnanVaihe lisatty = hakijaryhmaService.lisaaValinnanVaiheValintaryhmalle(parentOid, uusiValinnanVaihe, edellinenValinnanVaiheOid);
//
//        {
//            // Lopputilanne:
//            // ----Valintaryhmä (id 8)
...
//
//            List<ValinnanVaihe> vaiheet = hakijaryhmaService.findByValintaryhma(valintaryhmaOid);
...
//        ValinnanVaihe lisatty = hakijaryhmaService.lisaaValinnanVaiheValintaryhmalle(valintaryhmaOid, uusiVaihe, null);
//
//        {
//            assertNotNull(valintaryhmaDAO.readByOid(valintaryhmaOid));
//            assertEquals(0, valintaryhmaDAO.findChildrenByParentOid(valintaryhmaOid).size());
...
//            assertNotNull(valintaryhmaDAO.readByOid(valintaryhmaOid));
//            assertEquals(0, valintaryhmaDAO.findChildrenByParentOid(valintaryhmaOid).size());
//            assertEquals(0, hakijaryhmaService.findByValintaryhma(valintaryhmaOid).size());
//        }
//
//        ValinnanVaihe uusiVaihe = new ValinnanVaihe();
//        uusiVaihe.setAktiivinen(true);
...
//
//            assertEquals(0, hakijaryhmaService.findByValintaryhma("3301").size());
//            assertEquals(1, hakijaryhmaService.findByValintaryhma("3302").size());
//            assertEquals(1, hakijaryhmaService.findByHakukohde("3301").size());
//
//
//        }
//
...
//        uusiVaihe.setValinnanVaiheTyyppi(ValinnanVaiheTyyppi.TAVALLINEN);
//
//        ValinnanVaihe lisatty = hakijaryhmaService.lisaaValinnanVaiheValintaryhmalle("3301", uusiVaihe, null);
//
//        {
//            // VR1 3301 -> VV3
//            //   VR2 3302 -> VV3(C)
...
//            assertEquals(0, valintaryhmaDAO.findChildrenByParentOid("3302").size());
//
//            assertEquals(1, hakijaryhmaService.findByValintaryhma("3301").size());
//            assertEquals(2, hakijaryhmaService.findByValintaryhma("3302").size());
//            assertEquals(2, hakijaryhmaService.findByHakukohde("3301").size());
//        }
//    }
//
//    @Test
...
//
//            assertNotNull(valintaryhmaDAO.readByOid(valintaryhmaOid));
//            List<ValinnanVaihe> vr18Lvaiheet = hakijaryhmaService.findByValintaryhma(valintaryhmaOid);
...
//            List<ValinnanVaihe> vr19Lvaiheet = hakijaryhmaService.findByValintaryhma(vr19L.getOid());
...
//            List<ValinnanVaihe> vr20Lvaiheet = hakijaryhmaService.findByValintaryhma(vr20L.getOid());
...
//            List<ValinnanVaihe> hk9Lvaiheet = hakijaryhmaService.findByHakukohde(hk9L.getOid());
...
//        List<ValinnanVaihe> jarjestetty = hakijaryhmaService.jarjestaValinnanVaiheet(Arrays.asList(uusiJarjestys));
//
//        {
//            // Lopputilanne:
//            // ----Valintaryhmä (id 18)
...
//        {
//            ValinnanVaihe vaihe70L = hakijaryhmaDAO.readByOid(valinnanVaiheOid);
...
//
//            List<ValinnanVaihe> vaihe70Lkopiot = jarjestaVaiheetIdnMukaan(hakijaryhmaDAO.haeKopiot(vaihe70L.getOid()));
...
//
//            List<ValinnanVaihe> vaihe71Lkopiot = jarjestaVaiheetIdnMukaan(hakijaryhmaDAO.haeKopiot(vaihe71L.getOid()));
...
//
//            List<ValinnanVaihe> vaihe72Lkopiot = jarjestaVaiheetIdnMukaan(hakijaryhmaDAO.haeKopiot(vaihe72L.getOid()));
...
//
//            assertEquals(0, hakijaryhmaDAO.haeKopiot(vaihe74L.getOid()).size());
//        }
//
...
//
//        ValinnanVaihe paivitetty = hakijaryhmaService.update(valinnanVaiheOid, valinnanVaihe);
//        {
//            ValinnanVaihe vaihe70L = hakijaryhmaDAO.readByOid(valinnanVaiheOid);
//            assertNotNull(vaihe70L);
