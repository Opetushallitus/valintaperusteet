...
public class ValinnanVaiheDAOTest {
	...
	public void testHaeValintaryhmanViimeinenValinnanVaihe() {
		...
		ValinnanVaihe valinnanVaihe = valinnanVaiheDAO
				.haeValintaryhmanViimeinenValinnanVaihe(valintaryhmaOid);
		int i = 0;
		while (valinnanVaihe != null) {
			++i;
			assertEquals(valintaryhmaOid, valinnanVaihe.getValintaryhma()
					.getOid());
	...
	public void testFindValinnanvaihe() {
		...
		assertEquals(valinnanVaihe.getMaster().getId(), 20L);
	}
