...
/** User: wuoti Date: 30.9.2013 Time: 15.47 */
public class LukionValintaperusteetTest extends WithSpringBoot {
  ...
  private static final Map mustacheMap =
  ...
  public void testPainotettavatArvosanatKielienPainotus() {
    Hakemus hakemus =
        hakemus(
            yhdistaMapit(
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX
                        + LukionValintaperusteet.AIDINKIELI_JA_KIRJALLISUUS1,
                    "8.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.B1KIELI, "7.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX
                        + LukionValintaperusteet.B1KIELI
                        + OPPIAINE_POSTFIX,
                    LukionValintaperusteet.SAKSA),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.A11KIELI, "7.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX
                        + LukionValintaperusteet.A11KIELI
                        + OPPIAINE_POSTFIX,
                    LukionValintaperusteet.LATVIA),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.USKONTO, "6.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.HISTORIA, "7.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.YHTEISKUNTAOPPI,
                    "8.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.MATEMATIIKKA,
                    "8.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.FYSIIKKA, "7.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.KEMIA, "6.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.BIOLOGIA, "10.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.TERVEYSTIETO,
                    "6.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.MAANTIETO, "5.0")));
    ...
    Hakukohde hakukohde =
        new Hakukohde(
            ...
            yhdistaMapit(
                valintaperuste(
                    LukionValintaperusteet.AIDINKIELI_JA_KIRJALLISUUS1
                        + LukionValintaperusteet.PAINOKERROIN_POSTFIX,
                    "1.5"),
                valintaperuste(
                    LukionValintaperusteet.B1KIELI
                        + "_"
    ...
    Lukuarvofunktio lasku =
        Laskentadomainkonvertteri.muodostaLukuarvolasku(
            laajennaAlakaavat(LukionValintaperusteet.painotettuLukuaineidenKeskiarvo())
                .getFunktiokutsu());
    Laskentatulos<BigDecimal> tulos =
        laskentaService.suoritaValintalaskenta(hakukohde, hakemus, new ArrayList<Hakemus>(), lasku);
        ...
        hakemus(
            yhdistaMapit(
                ...
                valintaperuste(
                    ...
                    LukionValintaperusteet.LATVIA),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.B21KIELI, "7.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX
                        + LukionValintaperusteet.B21KIELI
                        + OPPIAINE_POSTFIX,
                    LukionValintaperusteet.RANSKA),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.USKONTO, "6.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.HISTORIA, "7.0"),
                ...
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.MAANTIETO, "5.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.LIIKUNTA, "8.0"),
                valintaperuste(
                    LukionValintaperusteet.AINE_PREFIX + LukionValintaperusteet.KUVATAIDE, "10.0")
        ...
        new Hakukohde(
            ...
            yhdistaMapit(
                ...
                valintaperuste(
                    ...
                    "5.0"),
                valintaperuste(
                    LukionValintaperusteet.LIIKUNTA + LukionValintaperusteet.PAINOKERROIN_POSTFIX,
                    "2.0"),
                valintaperuste(
                    LukionValintaperusteet.KUVATAIDE + LukionValintaperusteet.PAINOKERROIN_POSTFIX,
                    "2.5"),
                mustacheMap
                ...
                //                valintaperuste("kielikoe_tunniste","Gymnasiets
                // bildkonstlinje_kielikoe"),
                ...
                //                valintaperuste("lisanaytto_tunniste","Gymnasiets
                // bildkonstlinje_lisanaytto"),
                //                valintaperuste("lisapiste_tunniste","Gymnasiets
                // bildkonstlinje_lisapiste"),
                ...
                //                valintaperuste("paasykoe_tunniste","Gymnasiets
                // bildkonstlinje_paasykoe"),
  ...
  public void testHylkaaArvovalilla() {
    ...
    Hakemus hakemusHylattyPaasykoe =
        hakemus(
            yhdistaMapit(
    ...
    Hakemus hakemusHylattyLisanaytto =
        hakemus(
            yhdistaMapit(
    ...
    Hakemus hakemusHylattyMolemmat =
        hakemus(
            yhdistaMapit(
    ...
    Hakukohde hakukohde = new Hakukohde(HAKUKOHDE_OID1, yhdistaMapit(mustacheMap), korkeakouluhaku);

    Lukuarvofunktio lasku =
        Laskentadomainkonvertteri.muodostaLukuarvolasku(
            laajennaAlakaavat(LukionValintaperusteet.paasykoeLukuarvo("paasykoe_tunniste"))
                .getFunktiokutsu());
    Laskentatulos<BigDecimal> tulos =
        laskentaService.suoritaValintalaskenta(hakukohde, hakemus, new ArrayList<Hakemus>(), lasku);
    ...
    tulos =
        laskentaService.suoritaValintalaskenta(
            hakukohde, hakemusHylattyPaasykoe, new ArrayList<Hakemus>(), lasku);
    assertTrue(new BigDecimal("1.5").compareTo(tulos.getTulos()) == 0);
    assertEquals(Tila.Tilatyyppi.HYLATTY, tulos.getTila().getTilatyyppi());

    lasku =
        Laskentadomainkonvertteri.muodostaLukuarvolasku(
            laajennaAlakaavat(LukionValintaperusteet.lisanayttoLukuarvo("lisanaytto_tunniste"))
                .getFunktiokutsu());
    tulos =
        laskentaService.suoritaValintalaskenta(
            hakukohde, hakemusHylattyLisanaytto, new ArrayList<Hakemus>(), lasku);
    ...
    lasku =
        Laskentadomainkonvertteri.muodostaLukuarvolasku(
            laajennaAlakaavat(
                    LukionValintaperusteet.paasykoeJaLisanaytto(
                        LukionValintaperusteet.paasykoeLukuarvo("paasykoe_tunniste"),
    ...
    tulos =
        laskentaService.suoritaValintalaskenta(
            hakukohde, hakemusHylattyMolemmat, new ArrayList<Hakemus>(), lasku);
