...
public class ValintatapajonoServiceTest {
	...
	public void testFindJonoByValinnanvaihe() throws Exception {
		List<Valintatapajono> valintatapajonoByValinnanvaihe = valintatapajonoService
				.findJonoByValinnanvaihe("1");

		assertEquals(5, valintatapajonoByValinnanvaihe.size());
	}

	private boolean valintatapajonotOvatKopioita(Valintatapajono jono1,
			Valintatapajono jono2) {
		return jono1.getAktiivinen().equals(jono2.getAktiivinen())
				&& jono1.getSiirretaanSijoitteluun().equals(
						jono2.getSiirretaanSijoitteluun())
				...
				&& jono1.getTasapistesaanto()
						.equals(jono2.getTasapistesaanto());
	}
	...
	public void lisaaValintatapajonoValinnanVaiheelle() {
		...
		final String kopioValinnanVaiheOid = "46";
		{
			...
			List<Valintatapajono> vv45Ljonot = valintatapajonoService
					.findJonoByValinnanvaihe(masterValinnanVaiheOid);
			assertEquals(3, vv45Ljonot.size());
			assertTrue(vv45Ljonot.get(0).getId() == 1050L
					&& vv45Ljonot.get(0).getMasterValintatapajono() == null);
			assertTrue(vv45Ljonot.get(1).getId() == 1051L
					&& vv45Ljonot.get(1).getMasterValintatapajono() == null);
			assertTrue(vv45Ljonot.get(2).getId() == 1052L
					&& vv45Ljonot.get(1).getMasterValintatapajono() == null);

			ValinnanVaihe vv46L = valinnanVaiheDAO
					.readByOid(kopioValinnanVaiheOid);
			assertNotNull(vv46L);
			assertEquals(45L, vv46L.getMasterValinnanVaihe().getId());
			List<Valintatapajono> vv46Ljonot = valintatapajonoService
					.findJonoByValinnanvaihe(kopioValinnanVaiheOid);
			assertEquals(4, vv46Ljonot.size());

			assertTrue(vv46Ljonot.get(0).getId() == 1053L
					&& vv46Ljonot.get(0).getMasterValintatapajono().getId() == 1050L);
			assertTrue(vv46Ljonot.get(1).getId() == 1054L
					&& vv46Ljonot.get(1).getMasterValintatapajono().getId() == 1051L);
			assertTrue(vv46Ljonot.get(2).getId() == 1055L
					&& vv46Ljonot.get(2).getMasterValintatapajono() == null);
			assertTrue(vv46Ljonot.get(3).getId() == 1056L
					&& vv46Ljonot.get(3).getMasterValintatapajono().getId() == 1052L);
		}
		...
		Valintatapajono lisatty = valintatapajonoService
				.lisaaValintatapajonoValinnanVaiheelle(masterValinnanVaiheOid,
...

		{
			...
			assertTrue(vv45Ljonot.get(3).getId() == 1052L
			...
			assertTrue(vv46Ljonot.get(1).getId() == 1054L
					&& vv46Ljonot.get(1).getMasterValintatapajono().getId() == 1051L);
			assertTrue(vv46Ljonot.get(2).getMasterValintatapajono()
					.equals(lisatty)
					&& valintatapajonotOvatKopioita(vv46Ljonot.get(2), lisatty));
			assertTrue(vv46Ljonot.get(3).getId() == 1055L
					&& vv46Ljonot.get(3).getMasterValintatapajono() == null);
			assertTrue(vv46Ljonot.get(4).getId() == 1056L
					&& vv46Ljonot.get(4).getMasterValintatapajono().getId() == 1052L);
		}
	}
	...
	public void lisaaValintatapajonoTyhjalleValinnanVaiheelle() {
		final String valinnanVaiheOid = "47";
		{
			...
			assertEquals(
					0,
					valintatapajonoService.findJonoByValinnanvaihe(
							valinnanVaiheOid).size());
		}
		...
		uusiJono.setSiirretaanSijoitteluun(true);
		Valintatapajono lisatty = valintatapajonoService
				.lisaaValintatapajonoValinnanVaiheelle(valinnanVaiheOid,
						uusiJono, null);

		{
			assertNotNull(valinnanVaiheDAO.readByOid(valinnanVaiheOid));
			List<Valintatapajono> jonot = valintatapajonoService
					.findJonoByValinnanvaihe(valinnanVaiheOid);
			assertEquals(1, jonot.size());
			assertTrue(jonot.get(0).getMasterValintatapajono() == null
					&& jonot.get(0).equals(lisatty));
		}
	}
	...
	public void lisaaValintatapajonoValinnanVaiheelleIlmanEdellista() {
		final String valinnanVaiheOid = "48";
		{
			...
			assertTrue(jonot.get(0).getId() == 1057L);
			assertTrue(jonot.get(1).getId() == 1058L);
			assertTrue(jonot.get(2).getId() == 1059L);
		}
	...
	public void testJarjestaValintatapajonot() {
		...
		final String kopioValinnanVaiheOid = "69";
		{
			...
			assertNotNull(valinnanVaiheDAO.readByOid(valinnanVaiheOid));
			List<Valintatapajono> vv68Ljonot = valintatapajonoService
					.findJonoByValinnanvaihe(valinnanVaiheOid);
			assertEquals(3, vv68Ljonot.size());
			assertTrue(vv68Ljonot.get(0).getId() == 18L
					&& vv68Ljonot.get(0).getMasterValintatapajono() == null);
			assertTrue(vv68Ljonot.get(1).getId() == 19L
					&& vv68Ljonot.get(1).getMasterValintatapajono() == null);
			assertTrue(vv68Ljonot.get(2).getId() == 20L
					&& vv68Ljonot.get(2).getMasterValintatapajono() == null);

			assertNotNull(valinnanVaiheDAO.readByOid(kopioValinnanVaiheOid));
			List<Valintatapajono> vv69Ljonot = valintatapajonoService
					.findJonoByValinnanvaihe(kopioValinnanVaiheOid);
			assertEquals(5, vv69Ljonot.size());
			assertTrue(vv69Ljonot.get(0).getId() == 21L
					&& vv69Ljonot.get(0).getMasterValintatapajono() == null);
			assertTrue(vv69Ljonot.get(1).getId() == 22L
					&& vv69Ljonot.get(1).getMasterValintatapajono().getId() == 18L);
			assertTrue(vv69Ljonot.get(2).getId() == 23L
					&& vv69Ljonot.get(2).getMasterValintatapajono().getId() == 20L);
			assertTrue(vv69Ljonot.get(3).getId() == 24L
					&& vv69Ljonot.get(3).getMasterValintatapajono() == null);
			assertTrue(vv69Ljonot.get(4).getId() == 25L
					&& vv69Ljonot.get(4).getMasterValintatapajono().getId() == 19L);
		}

		String[] uusiJarjestys = new String[] { "20", "18", "19" };
		valintatapajonoService.jarjestaValintatapajonot(Arrays
				.asList(uusiJarjestys));

		{
			...
			List<Valintatapajono> vv68Ljonot = valintatapajonoService
					.findJonoByValinnanvaihe(valinnanVaiheOid);
			assertEquals(3, vv68Ljonot.size());
			assertTrue(vv68Ljonot.get(0).getId() == 20L
					&& vv68Ljonot.get(0).getMasterValintatapajono() == null);
			assertTrue(vv68Ljonot.get(1).getId() == 18L
					&& vv68Ljonot.get(1).getMasterValintatapajono() == null);
			assertTrue(vv68Ljonot.get(2).getId() == 19L
					&& vv68Ljonot.get(2).getMasterValintatapajono() == null);
			...
			assertTrue(vv69Ljonot.get(0).getId() == 21L
					&& vv69Ljonot.get(0).getMasterValintatapajono() == null);
			assertTrue(vv69Ljonot.get(1).getId() == 23L
					&& vv69Ljonot.get(1).getMasterValintatapajono().getId() == 20L);
			assertTrue(vv69Ljonot.get(2).getId() == 24L
					&& vv69Ljonot.get(2).getMasterValintatapajono() == null);
			assertTrue(vv69Ljonot.get(3).getId() == 22L
					&& vv69Ljonot.get(3).getMasterValintatapajono().getId() == 18L);
			assertTrue(vv69Ljonot.get(4).getId() == 25L
					&& vv69Ljonot.get(4).getMasterValintatapajono().getId() == 19L);
		}
	}

	private List<Valintatapajono> jarjestaJonotIdnMukaan(
			Collection<Valintatapajono> jonot) {
		List<Valintatapajono> jarjestetty = new ArrayList<Valintatapajono>(
				jonot);
	...
	public void testUpdate() {
		...
		{
			Valintatapajono jono26L = valintatapajonoService
					.readByOid(valintatapajonoOid);
			assertNotNull(jono26L);
			assertNotSame(uusiNimi, jono26L.getNimi());
			assertNotSame(uusiKuvaus, jono26L.getKuvaus());
			assertTrue(!uusiTasapistesaanto
					.equals(jono26L.getTasapistesaanto()));
			assertTrue(!uusiAloituspaikat.equals(jono26L.getAloituspaikat()));

			List<Valintatapajono> jono26Lkopiot = jarjestaJonotIdnMukaan(valintatapajonoDAO
					.haeKopiot(jono26L.getOid()));
			...
			assertTrue(!uusiTasapistesaanto
					.equals(jono27L.getTasapistesaanto()));
			assertTrue(!uusiAloituspaikat.equals(jono27L.getAloituspaikat()));

			List<Valintatapajono> jono27Lkopiot = jarjestaJonotIdnMukaan(valintatapajonoDAO
					.haeKopiot(jono27L.getOid()));
			...
			assertTrue(!uusiTasapistesaanto
					.equals(jono28L.getTasapistesaanto()));
			assertTrue(!uusiAloituspaikat.equals(jono28L.getAloituspaikat()));

			List<Valintatapajono> jono28Lkopiot = jarjestaJonotIdnMukaan(valintatapajonoDAO
					.haeKopiot(jono28L.getOid()));
			...
			assertTrue(!uusiTasapistesaanto
					.equals(jono29L.getTasapistesaanto()));
			assertTrue(!uusiAloituspaikat.equals(jono29L.getAloituspaikat()));
			assertEquals(0, valintatapajonoDAO.haeKopiot(jono29L.getOid())
					.size());
			...
			assertTrue(!uusiTasapistesaanto
					.equals(jono30L.getTasapistesaanto()));
			assertTrue(!uusiAloituspaikat.equals(jono30L.getAloituspaikat()));
			assertEquals(0, valintatapajonoDAO.haeKopiot(jono30L.getOid())
					.size());
		}
		...
		paivitys.setTasapistesaanto(new ModelMapper()
				.map(uusiTasapistesaanto,
						fi.vm.sade.service.valintaperusteet.dto.model.Tasapistesaanto.class));
		paivitys.setKaytetaanValintalaskentaa(true);

		Valintatapajono paivitetty = valintatapajonoService.update(
				valintatapajonoOid, paivitys);
		{
			Valintatapajono jono26L = valintatapajonoService
					.readByOid(valintatapajonoOid);
			assertNotNull(jono26L);
