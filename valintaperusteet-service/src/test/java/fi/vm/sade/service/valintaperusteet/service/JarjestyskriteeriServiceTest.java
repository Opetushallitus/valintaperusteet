...
public class JarjestyskriteeriServiceTest {
	...
	public void testLisaaJarjestyskriteeri() {
		...
		Jarjestyskriteeri lisatty = jarjestyskriteeriService
				.lisaaJarjestyskriteeriValintatapajonolle(valintatapajonoOid,
						jarjestyskriteeri, null, laskentakaavaId);
	...
	public void testUpdate() {
		...
		Jarjestyskriteeri jarjestyskriteeri = jarjestyskriteeriService
				.readByOid("3201");
	...
	public void lisaaJarjestyskriteeriTyhjalleValintatapajonolle() {
		...
		final String valintatapajonoOid = "3001";
		{
			...
			assertEquals(0, jarjestyskriteeriService
					.findJarjestyskriteeriByJono(valintatapajonoOid).size());
		}
...

		{
			...
			assertNotNull(valintatapajonoDAO.readByOid(valintatapajonoOid));
			List<Jarjestyskriteeri> jarjestyskriteeriList = jarjestyskriteeriService
					.findJarjestyskriteeriByJono(valintatapajonoOid);
			...
			jarjestyskriteeriList = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3002");
			assertEquals(1, jarjestyskriteeriList.size());
			assertTrue(jarjestyskriteeriList.get(0).getMaster() != null);

			jarjestyskriteeriList = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3003");
			assertEquals(1, jarjestyskriteeriList.size());
			assertTrue(jarjestyskriteeriList.get(0).getMaster() != null);
		}
	}
	...
	public void lisaaJarjestyskriteeriValintatapajonolle() {
		...
		{
			assertNotNull(valintatapajonoDAO.readByOid(valintatapajonoOid));
			assertEquals(3, jarjestyskriteeriService
					.findJarjestyskriteeriByJono(valintatapajonoOid).size());
			assertNotNull(valintatapajonoDAO.readByOid("3102"));
			assertEquals(4, jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3102").size());
			assertNotNull(valintatapajonoDAO.readByOid("3103"));
			assertEquals(5, jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3103").size());
		}
...

		{
			...
			assertTrue(jarjestyskriteeriList.get(1).getMaster() == null
					&& jarjestyskriteeriList.get(1).equals(lisatty));

			jarjestyskriteeriList = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3102");
			...
			jarjestyskriteeriList = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3103");
		...
		uusiJK.setAktiivinen(true);
		uusiJK.setMetatiedot("uusi kuvaus");
		lisatty = jarjestyskriteeriService
				.lisaaJarjestyskriteeriValintatapajonolle(valintatapajonoOid,
						uusiJK, "3110", 1L);

		{
			...
			assertNotNull(valintatapajonoDAO.readByOid(valintatapajonoOid));
			List<Jarjestyskriteeri> jarjestyskriteeriList = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3101");
			assertEquals(4, jarjestyskriteeriList.size());

			jarjestyskriteeriList = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3102");
			assertEquals(6, jarjestyskriteeriList.size());
			assertTrue(jarjestyskriteeriList.get(3).getMaster() == null
					&& jarjestyskriteeriList.get(3).equals(lisatty));

			jarjestyskriteeriList = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3103");
			assertEquals(7, jarjestyskriteeriList.size());
			assertTrue(jarjestyskriteeriList.get(4).getMaster() != null
...

		{
			...
			assertTrue(jarjestyskriteeriList.get(6).getMaster() == null
	...
	public void testJarjesta() {
		{
			...
			List<Jarjestyskriteeri> jono1 = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3201");
			assertEquals(3, jono1.size());
			assertTrue(jono1.get(0).getId() == 3201L
					&& jono1.get(0).getMaster() == null);
			assertTrue(jono1.get(1).getId() == 3202L
					&& jono1.get(1).getMaster() == null);
			assertTrue(jono1.get(2).getId() == 3203L
					&& jono1.get(2).getMaster() == null);

			List<Jarjestyskriteeri> jono2 = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3202");
			assertEquals(4, jono2.size());
			assertTrue(jono2.get(0).getId() == 3204L
					&& jono2.get(0).getMaster() != null);
			assertTrue(jono2.get(1).getId() == 3210L
					&& jono2.get(1).getMaster() == null);
			assertTrue(jono2.get(2).getId() == 3205L
					&& jono2.get(2).getMaster() != null);
			assertTrue(jono2.get(3).getId() == 3206L
					&& jono2.get(3).getMaster() != null);

			List<Jarjestyskriteeri> jono3 = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3203");
			assertEquals(5, jono3.size());
			assertTrue(jono3.get(0).getId() == 3207L
					&& jono3.get(0).getMaster() != null);
			assertTrue(jono3.get(1).getId() == 3212L
					&& jono3.get(1).getMaster() == null);
			assertTrue(jono3.get(2).getId() == 3211L
					&& jono3.get(2).getMaster() != null);
			assertTrue(jono3.get(3).getId() == 3208L
					&& jono3.get(3).getMaster() != null);
			assertTrue(jono3.get(4).getId() == 3209L
					&& jono3.get(4).getMaster() != null);

		}

		String[] uusiJarjestys = { "3203", "3202", "3201" };
		List<Jarjestyskriteeri> jarjestetty = jarjestyskriteeriService
				.jarjestaKriteerit(Arrays.asList(uusiJarjestys));

		{
			...
			List<Jarjestyskriteeri> jono1 = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3201");
			assertEquals(3, jono1.size());
			assertTrue(jono1.get(0).getId() == 3203L
					&& jono1.get(0).getMaster() == null);
			assertTrue(jono1.get(1).getId() == 3202L
					&& jono1.get(1).getMaster() == null);
			assertTrue(jono1.get(2).getId() == 3201L
					&& jono1.get(2).getMaster() == null);

			List<Jarjestyskriteeri> jono2 = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3202");
			assertEquals(4, jono2.size());
			assertTrue(jono2.get(0).getId() == 3206L
					&& jono2.get(0).getMaster() != null);
			assertTrue(jono2.get(1).getId() == 3205L
					&& jono2.get(1).getMaster() != null);
			assertTrue(jono2.get(2).getId() == 3204L
					&& jono2.get(2).getMaster() != null);
			assertTrue(jono2.get(3).getId() == 3210L
					&& jono2.get(3).getMaster() == null);

			List<Jarjestyskriteeri> jono3 = jarjestyskriteeriService
					.findJarjestyskriteeriByJono("3203");
			assertEquals(5, jono3.size());
			assertTrue(jono3.get(0).getId() == 3209L
					&& jono3.get(0).getMaster() != null);
			assertTrue(jono3.get(1).getId() == 3208L
					&& jono3.get(1).getMaster() != null);
			assertTrue(jono3.get(2).getId() == 3207L
					&& jono3.get(2).getMaster() != null);
			assertTrue(jono3.get(3).getId() == 3212L
					&& jono3.get(3).getMaster() == null);
			assertTrue(jono3.get(4).getId() == 3211L
					&& jono3.get(4).getMaster() != null);
		}
	}
	...
	public void testHakukohdeInsert() {
		...
		// Joo-o
		int size = insert.getValinnanvaiheet().iterator().next().getJonot()
				.iterator().next().getJarjestyskriteerit().size();
		assertEquals(4, size);
	}
}
