...
public class ValinnanVaiheServiceTest {
	...
	private List<Valintaryhma> jarjestaValintaryhmatIdnMukaan(
			List<Valintaryhma> vr) {
	...
	private boolean valinnanVaiheetOvatKopioita(ValinnanVaihe vv1,
			ValinnanVaihe vv2) {
		return vv1.getNimi().equals(vv2.getNimi())
				&& vv1.getAktiivinen().equals(vv2.getAktiivinen())
	...
	public void testLisaaValinnanVaiheValintaryhmalle() {
...

		{
			...
			List<HakukohdeViite> vr8Lhakukohteet = hakukohdeViiteDAO
					.findByValintaryhmaOid(parentOid);
			assertEquals(1, vr8Lhakukohteet.size());

			List<ValinnanVaihe> vr8Lvaiheet = valinnanVaiheService
					.findByValintaryhma(vr8L.getOid());
			assertEquals(3, vr8Lvaiheet.size());
			assertTrue(vr8Lvaiheet.get(0).getId() == 20L
					&& vr8Lvaiheet.get(0).getMasterValinnanVaihe() == null);
			assertTrue(vr8Lvaiheet.get(1).getId() == 21L
					&& vr8Lvaiheet.get(1).getMasterValinnanVaihe() == null);
			assertTrue(vr8Lvaiheet.get(2).getId() == 22L
			...
			List<ValinnanVaihe> hk7Lvaiheet = valinnanVaiheService
					.findByHakukohde(hk7L.getOid());
			assertEquals(3, hk7Lvaiheet.size());
			assertTrue(hk7Lvaiheet.get(0).getId() == 35L
					&& hk7Lvaiheet.get(0).getMasterValinnanVaihe().getId() == 21L);
			assertTrue(hk7Lvaiheet.get(1).getId() == 36L
					&& hk7Lvaiheet.get(1).getMasterValinnanVaihe().getId() == 20L);
			assertTrue(hk7Lvaiheet.get(2).getId() == 37L
					&& hk7Lvaiheet.get(2).getMasterValinnanVaihe().getId() == 22L);
			...
			List<ValinnanVaihe> vr9Lvaiheet = valinnanVaiheService
					.findByValintaryhma(vr9L.getOid());
			assertEquals(4, vr9Lvaiheet.size());
			assertTrue(vr9Lvaiheet.get(0).getId() == 23L
					&& vr9Lvaiheet.get(0).getMasterValinnanVaihe().getId() == 20L);
			assertTrue(vr9Lvaiheet.get(1).getId() == 24L
					&& vr9Lvaiheet.get(1).getMasterValinnanVaihe().getId() == 21L);
			assertTrue(vr9Lvaiheet.get(2).getId() == 25L
					&& vr9Lvaiheet.get(2).getMasterValinnanVaihe() == null);
			assertTrue(vr9Lvaiheet.get(3).getId() == 26L
					&& vr9Lvaiheet.get(3).getMasterValinnanVaihe().getId() == 22L);

			List<HakukohdeViite> vr9Lhakukohteet = hakukohdeViiteDAO
					.findByValintaryhmaOid(vr9L.getOid());
			assertEquals(1, vr9Lhakukohteet.size());

			HakukohdeViite hk8L = vr9Lhakukohteet.get(0);
			List<ValinnanVaihe> hk8Lvaiheet = valinnanVaiheService
					.findByHakukohde(hk8L.getOid());
			assertEquals(4, hk8Lvaiheet.size());
			assertTrue(hk8Lvaiheet.get(0).getId() == 38L
					&& hk8Lvaiheet.get(0).getMasterValinnanVaihe().getId() == 23L);
			assertTrue(hk8Lvaiheet.get(1).getId() == 39L
					&& hk8Lvaiheet.get(1).getMasterValinnanVaihe().getId() == 24L);
			assertTrue(hk8Lvaiheet.get(2).getId() == 40L
					&& hk8Lvaiheet.get(2).getMasterValinnanVaihe().getId() == 25L);
			assertTrue(hk8Lvaiheet.get(3).getId() == 41L
					&& hk8Lvaiheet.get(3).getMasterValinnanVaihe().getId() == 26L);

			List<ValinnanVaihe> vr11Lvaiheet = valinnanVaiheService
					.findByValintaryhma(vr11L.getOid());
			assertEquals(3, vr11Lvaiheet.size());
			assertTrue(vr11Lvaiheet.get(0).getId() == 32L
					&& vr11Lvaiheet.get(0).getMasterValinnanVaihe().getId() == 20L);
			assertTrue(vr11Lvaiheet.get(1).getId() == 33L
					&& vr11Lvaiheet.get(1).getMasterValinnanVaihe().getId() == 21L);
			assertTrue(vr11Lvaiheet.get(2).getId() == 34L
					&& vr11Lvaiheet.get(2).getMasterValinnanVaihe().getId() == 22L);

			Valintaryhma vr10L = vr9Lalaryhmat.get(0);
			assertEquals(0,
					valintaryhmaDAO.findChildrenByParentOid(vr10L.getOid())
							.size());
			List<ValinnanVaihe> vr10Lvaiheet = valinnanVaiheService
					.findByValintaryhma(vr10L.getOid());
			assertEquals(5, vr10Lvaiheet.size());
			assertTrue(vr10Lvaiheet.get(0).getId() == 27L
					&& vr10Lvaiheet.get(0).getMasterValinnanVaihe().getId() == 26L);
			assertTrue(vr10Lvaiheet.get(1).getId() == 28L
					&& vr10Lvaiheet.get(1).getMasterValinnanVaihe().getId() == 25L);
			assertTrue(vr10Lvaiheet.get(2).getId() == 29L
					&& vr10Lvaiheet.get(2).getMasterValinnanVaihe().getId() == 23L);
			assertTrue(vr10Lvaiheet.get(3).getId() == 30L
					&& vr10Lvaiheet.get(3).getMasterValinnanVaihe() == null);
			assertTrue(vr10Lvaiheet.get(4).getId() == 31L
					&& vr10Lvaiheet.get(4).getMasterValinnanVaihe().getId() == 24L);
		}
		...
		final ValinnanVaihe lisatty = valinnanVaiheService
				.lisaaValinnanVaiheValintaryhmalle(parentOid,
...

		{
			...
			assertTrue(vr8Lvaiheet.get(0).getId() == 20L
					&& vr8Lvaiheet.get(0).getMasterValinnanVaihe() == null);
			assertTrue(vr8Lvaiheet.get(1).equals(lisatty)
					&& vr8Lvaiheet.get(1).getMasterValinnanVaihe() == null);
			assertTrue(vr8Lvaiheet.get(2).getId() == 21L
					&& vr8Lvaiheet.get(2).getMasterValinnanVaihe() == null);
			assertTrue(vr8Lvaiheet.get(3).getId() == 22L
			...
			assertTrue(hk7Lvaiheet.get(1).getId() == 36L
					&& hk7Lvaiheet.get(1).getMasterValinnanVaihe().getId() == 20L);
			assertTrue(hk7Lvaiheet.get(2).getMasterValinnanVaihe()
					.equals(lisatty)
					&& valinnanVaiheetOvatKopioita(hk7Lvaiheet.get(2), lisatty));
			assertTrue(hk7Lvaiheet.get(3).getId() == 37L
					&& hk7Lvaiheet.get(3).getMasterValinnanVaihe().getId() == 22L);
			...
			assertTrue(vr9Lvaiheet.get(0).getId() == 23L
					&& vr9Lvaiheet.get(0).getMasterValinnanVaihe().getId() == 20L);
			assertTrue(vr9Lvaiheet.get(1).getMasterValinnanVaihe()
					.equals(lisatty)
					&& valinnanVaiheetOvatKopioita(vr9Lvaiheet.get(1), lisatty));
			assertTrue(vr9Lvaiheet.get(2).getId() == 24L
					&& vr9Lvaiheet.get(2).getMasterValinnanVaihe().getId() == 21L);
			assertTrue(vr9Lvaiheet.get(3).getId() == 25L
					&& vr9Lvaiheet.get(3).getMasterValinnanVaihe() == null);
			assertTrue(vr9Lvaiheet.get(4).getId() == 26L
					&& vr9Lvaiheet.get(4).getMasterValinnanVaihe().getId() == 22L);
			...
			assertTrue(hk8Lvaiheet.get(0).getId() == 38L
					&& hk8Lvaiheet.get(0).getMasterValinnanVaihe().getId() == 23L);
			assertTrue(hk8Lvaiheet.get(1).getMasterValinnanVaihe()
					.equals(lisatynKopio)
					&& valinnanVaiheetOvatKopioita(hk8Lvaiheet.get(1), lisatty));
			assertTrue(hk8Lvaiheet.get(2).getId() == 39L
					&& hk8Lvaiheet.get(2).getMasterValinnanVaihe().getId() == 24L);
			assertTrue(hk8Lvaiheet.get(3).getId() == 40L
					&& hk8Lvaiheet.get(3).getMasterValinnanVaihe().getId() == 25L);
			assertTrue(hk8Lvaiheet.get(4).getId() == 41L
					&& hk8Lvaiheet.get(4).getMasterValinnanVaihe().getId() == 26L);
			...
			assertTrue(vr11Lvaiheet.get(0).getId() == 32L
					&& vr11Lvaiheet.get(0).getMasterValinnanVaihe().getId() == 20L);
			assertTrue(vr11Lvaiheet.get(1).getMasterValinnanVaihe()
					.equals(lisatty)
					&& valinnanVaiheetOvatKopioita(vr11Lvaiheet.get(1), lisatty));
			assertTrue(vr11Lvaiheet.get(2).getId() == 33L
					&& vr11Lvaiheet.get(2).getMasterValinnanVaihe().getId() == 21L);
			assertTrue(vr11Lvaiheet.get(3).getId() == 34L
					&& vr11Lvaiheet.get(3).getMasterValinnanVaihe().getId() == 22L);
			...
			assertTrue(vr10Lvaiheet.get(2).getId() == 29L
					&& vr10Lvaiheet.get(2).getMasterValinnanVaihe().getId() == 23L);
			assertTrue(vr10Lvaiheet.get(3).getMasterValinnanVaihe()
					.equals(lisatynKopio)
					&& valinnanVaiheetOvatKopioita(vr10Lvaiheet.get(3), lisatty));
			assertTrue(vr10Lvaiheet.get(4).getId() == 30L
					&& vr10Lvaiheet.get(4).getMasterValinnanVaihe() == null);
			assertTrue(vr10Lvaiheet.get(5).getId() == 31L
					&& vr10Lvaiheet.get(5).getMasterValinnanVaihe().getId() == 24L);
		}
	}
	...
	public void testLisaaValinnanVaiheIlmanEdellistaValintaryhmalle() {
...

		{
			...
			assertEquals(0,
					valintaryhmaDAO.findChildrenByParentOid(valintaryhmaOid)
							.size());

			List<ValinnanVaihe> vaiheet = valinnanVaiheService
					.findByValintaryhma(valintaryhmaOid);
			assertEquals(3, vaiheet.size());

			assertEquals(42L, vaiheet.get(0).getId());
			assertEquals(43L, vaiheet.get(1).getId());
			assertEquals(44L, vaiheet.get(2).getId());
		}
		...
		ValinnanVaihe lisatty = valinnanVaiheService
				.lisaaValinnanVaiheValintaryhmalle(valintaryhmaOid, uusiVaihe,
						null);
	...
	public void testLisaaValinnanVaiheValintaryhmaanJonkaLapsellaOnYksiValinnavaihe() {
		{
			...
			assertEquals(1, valintaryhmaDAO.findChildrenByParentOid("3301")
					.size());
			assertEquals("3302", valintaryhmaDAO
					.findChildrenByParentOid("3301").get(0).getOid());
			assertEquals(0, valintaryhmaDAO.findChildrenByParentOid("3302")
					.size());

			assertEquals(0, valinnanVaiheService.findByValintaryhma("3301")
					.size());
			assertEquals(1, valinnanVaiheService.findByValintaryhma("3302")
					.size());
		...
		ValinnanVaihe lisatty = valinnanVaiheService
				.lisaaValinnanVaiheValintaryhmalle("3301", uusiVaihe, null);

		{
			...
			assertEquals(1, valinnanVaiheService.findByValintaryhma("3301")
					.size());
			assertEquals(2, valinnanVaiheService.findByValintaryhma("3302")
					.size());
	...
	public void testJarjestaValintaryhmanValinnanVaiheet() {
...

		{
			...
			assertNotNull(valintaryhmaService.readByOid(valintaryhmaOid));
			List<ValinnanVaihe> vr18Lvaiheet = valinnanVaiheService
					.findByValintaryhma(valintaryhmaOid);
			assertEquals(3, vr18Lvaiheet.size());
			assertTrue(vr18Lvaiheet.get(0).getId() == 49L
					&& vr18Lvaiheet.get(0).getMasterValinnanVaihe() == null);
			assertTrue(vr18Lvaiheet.get(1).getId() == 50L
					&& vr18Lvaiheet.get(1).getMasterValinnanVaihe() == null);
			assertTrue(vr18Lvaiheet.get(2).getId() == 51L
					&& vr18Lvaiheet.get(2).getMasterValinnanVaihe() == null);

			List<Valintaryhma> vr18Lalavalintaryhmat = valintaryhmaDAO
					.findChildrenByParentOid(valintaryhmaOid);
			assertEquals(1, vr18Lalavalintaryhmat.size());

			Valintaryhma vr19L = vr18Lalavalintaryhmat.get(0);
			List<ValinnanVaihe> vr19Lvaiheet = valinnanVaiheService
					.findByValintaryhma(vr19L.getOid());
			assertEquals(4, vr19Lvaiheet.size());
			assertTrue(vr19Lvaiheet.get(0).getId() == 52L
					&& vr19Lvaiheet.get(0).getMasterValinnanVaihe().getId() == 49L);
			assertTrue(vr19Lvaiheet.get(1).getId() == 53L
					&& vr19Lvaiheet.get(1).getMasterValinnanVaihe().getId() == 50L);
			assertTrue(vr19Lvaiheet.get(2).getId() == 54L
					&& vr19Lvaiheet.get(2).getMasterValinnanVaihe() == null);
			assertTrue(vr19Lvaiheet.get(3).getId() == 55L
					&& vr19Lvaiheet.get(3).getMasterValinnanVaihe().getId() == 51L);

			List<Valintaryhma> vr19Lalavalintaryhmat = valintaryhmaDAO
					.findChildrenByParentOid(vr19L.getOid());
			assertEquals(1, vr19Lalavalintaryhmat.size());

			Valintaryhma vr20L = vr19Lalavalintaryhmat.get(0);
			List<ValinnanVaihe> vr20Lvaiheet = valinnanVaiheService
					.findByValintaryhma(vr20L.getOid());
			assertEquals(6, vr20Lvaiheet.size());
			assertTrue(vr20Lvaiheet.get(0).getId() == 56L
					&& vr20Lvaiheet.get(0).getMasterValinnanVaihe() == null);
			assertTrue(vr20Lvaiheet.get(1).getId() == 57L
					&& vr20Lvaiheet.get(1).getMasterValinnanVaihe() == null);
			assertTrue(vr20Lvaiheet.get(2).getId() == 58L
					&& vr20Lvaiheet.get(2).getMasterValinnanVaihe().getId() == 53L);
			assertTrue(vr20Lvaiheet.get(3).getId() == 59L
					&& vr20Lvaiheet.get(3).getMasterValinnanVaihe().getId() == 54L);
			assertTrue(vr20Lvaiheet.get(4).getId() == 60L
					&& vr20Lvaiheet.get(4).getMasterValinnanVaihe().getId() == 52L);
			assertTrue(vr20Lvaiheet.get(5).getId() == 61L
					&& vr20Lvaiheet.get(5).getMasterValinnanVaihe().getId() == 55L);

			List<HakukohdeViite> vr20Lhakukohteet = hakukohdeViiteDAO
					.findByValintaryhmaOid(vr20L.getOid());
			assertEquals(1, vr20Lhakukohteet.size());

			HakukohdeViite hk9L = vr20Lhakukohteet.get(0);
			List<ValinnanVaihe> hk9Lvaiheet = valinnanVaiheService
					.findByHakukohde(hk9L.getOid());
			assertEquals(6, hk9Lvaiheet.size());
			assertTrue(hk9Lvaiheet.get(0).getId() == 62L
					&& hk9Lvaiheet.get(0).getMasterValinnanVaihe().getId() == 56L);
			assertTrue(hk9Lvaiheet.get(1).getId() == 63L
					&& hk9Lvaiheet.get(1).getMasterValinnanVaihe().getId() == 57L);
			assertTrue(hk9Lvaiheet.get(2).getId() == 64L
					&& hk9Lvaiheet.get(2).getMasterValinnanVaihe().getId() == 58L);
			assertTrue(hk9Lvaiheet.get(3).getId() == 65L
					&& hk9Lvaiheet.get(3).getMasterValinnanVaihe().getId() == 59L);
			assertTrue(hk9Lvaiheet.get(4).getId() == 66L
					&& hk9Lvaiheet.get(4).getMasterValinnanVaihe().getId() == 60L);
			assertTrue(hk9Lvaiheet.get(5).getId() == 67L
					&& hk9Lvaiheet.get(5).getMasterValinnanVaihe().getId() == 61L);
		}

		String[] uusiJarjestys = { "51", "50", "49" };
		List<ValinnanVaihe> jarjestetty = valinnanVaiheService
				.jarjestaValinnanVaiheet(Arrays.asList(uusiJarjestys));

		{
			...
			List<ValinnanVaihe> vr18Lvaiheet = valinnanVaiheService
					.findByValintaryhma(valintaryhmaOid);
			assertEquals(3, vr18Lvaiheet.size());
			assertTrue(vr18Lvaiheet.get(0).getId() == 51L
					&& vr18Lvaiheet.get(0).getMasterValinnanVaihe() == null);
			assertTrue(vr18Lvaiheet.get(1).getId() == 50L
					&& vr18Lvaiheet.get(1).getMasterValinnanVaihe() == null);
			assertTrue(vr18Lvaiheet.get(2).getId() == 49L
					&& vr18Lvaiheet.get(2).getMasterValinnanVaihe() == null);
			...
			List<ValinnanVaihe> vr19Lvaiheet = valinnanVaiheService
					.findByValintaryhma(vr19L.getOid());
			assertEquals(4, vr19Lvaiheet.size());
			assertTrue(vr19Lvaiheet.get(0).getId() == 55L
					&& vr19Lvaiheet.get(0).getMasterValinnanVaihe().getId() == 51L);
			assertTrue(vr19Lvaiheet.get(1).getId() == 53L
					&& vr19Lvaiheet.get(1).getMasterValinnanVaihe().getId() == 50L);
			assertTrue(vr19Lvaiheet.get(2).getId() == 54L
					&& vr19Lvaiheet.get(2).getMasterValinnanVaihe() == null);
			assertTrue(vr19Lvaiheet.get(3).getId() == 52L
					&& vr19Lvaiheet.get(3).getMasterValinnanVaihe().getId() == 49L);
			...
			assertTrue(vr20Lvaiheet.get(1).getId() == 57L
					&& vr20Lvaiheet.get(1).getMasterValinnanVaihe() == null);
			assertTrue(vr20Lvaiheet.get(2).getId() == 61L
					&& vr20Lvaiheet.get(2).getMasterValinnanVaihe().getId() == 55L);
			assertTrue(vr20Lvaiheet.get(3).getId() == 58L
					&& vr20Lvaiheet.get(3).getMasterValinnanVaihe().getId() == 53L);
			assertTrue(vr20Lvaiheet.get(4).getId() == 59L
					&& vr20Lvaiheet.get(4).getMasterValinnanVaihe().getId() == 54L);
			assertTrue(vr20Lvaiheet.get(5).getId() == 60L
					&& vr20Lvaiheet.get(5).getMasterValinnanVaihe().getId() == 52L);
			...
			assertTrue(hk9Lvaiheet.get(1).getId() == 63L
					&& hk9Lvaiheet.get(1).getMasterValinnanVaihe().getId() == 57L);
			assertTrue(hk9Lvaiheet.get(2).getId() == 67L
					&& hk9Lvaiheet.get(2).getMasterValinnanVaihe().getId() == 61L);
			assertTrue(hk9Lvaiheet.get(3).getId() == 64L
					&& hk9Lvaiheet.get(3).getMasterValinnanVaihe().getId() == 58L);
			assertTrue(hk9Lvaiheet.get(4).getId() == 65L
					&& hk9Lvaiheet.get(4).getMasterValinnanVaihe().getId() == 59L);
			assertTrue(hk9Lvaiheet.get(5).getId() == 66L
					&& hk9Lvaiheet.get(5).getMasterValinnanVaihe().getId() == 60L);
		}
	}

	private static List<ValinnanVaihe> jarjestaVaiheetIdnMukaan(
			Collection<ValinnanVaihe> vaiheet) {
	...
	public void testUpdate() {
		...
		{
			ValinnanVaihe vaihe70L = valinnanVaiheDAO
					.readByOid(valinnanVaiheOid);
			...
			List<ValinnanVaihe> vaihe70Lkopiot = jarjestaVaiheetIdnMukaan(valinnanVaiheDAO
					.haeKopiot(vaihe70L.getOid()));
			...
			List<ValinnanVaihe> vaihe71Lkopiot = jarjestaVaiheetIdnMukaan(valinnanVaiheDAO
					.haeKopiot(vaihe71L.getOid()));
			...
			List<ValinnanVaihe> vaihe72Lkopiot = jarjestaVaiheetIdnMukaan(valinnanVaiheDAO
					.haeKopiot(vaihe72L.getOid()));
			...
			assertEquals(0, valinnanVaiheDAO.haeKopiot(vaihe74L.getOid())
					.size());
		}
		...
		ValinnanVaihe paivitetty = valinnanVaiheService.update(
				valinnanVaiheOid, valinnanVaihe);
		{
			ValinnanVaihe vaihe70L = valinnanVaiheDAO
					.readByOid(valinnanVaiheOid);
			assertNotNull(vaihe70L);
