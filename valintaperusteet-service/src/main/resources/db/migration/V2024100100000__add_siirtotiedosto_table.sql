...
COMMENT ON COLUMN siirtotiedosto.window_start IS 'Siirtotiedosto-operaation aikaikkunan alkuaika (siirtotiedostoon tulevat tällä aikavälillä muuttuneet valintaperusteet)';
COMMENT ON COLUMN siirtotiedosto.window_end IS 'Siirtotiedosto-operaation aikaikkunan loppuaika (siirtotiedostoon tulevat tällä aikavälillä muuttuneet valintaperusteet)';
