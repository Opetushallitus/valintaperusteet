...
public class HakukohdeResourceImpl {
  ...
  protected static final Logger LOG = LoggerFactory.getLogger(ValintaryhmaResource.class);
  ...
  @ApiOperation(
      value = "Hakee hakukohteita. Joko kaikki tai päätason hakukohteet.",
  ...
  public List<HakukohdeViiteDTO> hakukohteet(
      @ApiParam(value = "Lista hakukohdeOideja", required = true) List<String> hakukohdeOidit) {
  ...
  @PreAuthorize(READ_UPDATE_CRUD)
  @ApiOperation(
      value = "Hakee valintaryhmät hakukohteiden OIDien perusteella",
            ...
            oid ->
                hakukohdeViiteDAO
                    ...
                    .flatMap(
                        valintaryhma ->
                            Optional.of(
                                new HakukohdeJaValintaryhmaDTO(
                                    oid,
                                    new ValintaryhmaDTO() {
                                      {
  ...
  public Response insert(
      @ApiParam(value = "Lisättävä hakukohde ja valintaryhmä", required = true)
          HakukohdeInsertDTO hakukohde,
  ...
  public Response update(
      @ApiParam(value = "Päivitettävän hakukohteen OID", required = true) @PathParam("oid")
          String oid,
      @ApiParam(value = "hakukohteen uudet tiedot", required = true)
  ...
  @PreAuthorize(READ_UPDATE_CRUD)
  @ApiOperation(
      value = "Hakee hakukohteen valinnan vaiheet OID:n perusteella",
      response = ValinnanVaiheDTO.class)
  public List<ValinnanVaiheDTO> valinnanVaihesForHakukohde(
      @ApiParam(value = "OID", required = true) @PathParam("oid") String oid,
      @DefaultValue("false") @QueryParam("withValisijoitteluTieto")
          String withValisijoitteluTieto) {
  ...
  @PreAuthorize(READ_UPDATE_CRUD)
  @ApiOperation(
      value = "Hakee hakukohteiden valinnan vaiheet OIDien perusteella",
      response = HakukohdeJaValinnanVaiheDTO.class)
  public List<HakukohdeJaValinnanVaiheDTO> valinnanVaiheetForHakukohteet(
      @ApiParam(value = "Hakukohde OIDit", required = true) List<String> hakukohdeOidit) {
    return hakukohdeOidit.stream()
        .map(
            (oid) -> {
  ...
  public List<ValintakoeDTO> valintakoesForHakukohde(
    ...
    try {
      ...
      Response response =
          Response.status(404).entity(message).type(MediaType.TEXT_PLAIN_TYPE).build();
  ...
  @PreAuthorize(READ_UPDATE_CRUD)
  @ApiOperation(
      value = "Palauttaa tiedon, kuuluuko hakukohde sijoitteluun",
  ...
  @PreAuthorize(READ_UPDATE_CRUD)
  @ApiOperation(
      value = "Hakee hakukohteiden hakijaryhmät",
      response = LinkitettyHakijaryhmaValintatapajonoDTO.class)
  ...
  @PreAuthorize(READ_UPDATE_CRUD)
  @ApiOperation(
      value = "Hakee hakukohteen järjestyskriteerit",
  ...
  @PreAuthorize(READ_UPDATE_CRUD)
  @ApiOperation(
      value = "Hakee hakukohteiden syötettävät tiedot",
  ...
  public Response liitaHakijaryhma(
      @ApiParam(value = "Hakukohteen OID, jolle hakijaryhmä liitetään", required = true)
          @PathParam("hakukohdeOid")
          String hakukohdeOid,
