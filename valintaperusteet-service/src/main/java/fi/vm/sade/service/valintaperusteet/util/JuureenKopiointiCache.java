 ...
 *
 * XXX: This cache is magical! When copying entity hierarchies the entries in these maps point across the two detached
 * hierarchies to ensure the new target hierarchy gets correct IDs. While kind of nifty in function, this is really
 * confusing and error prone if caching is not done for all dependent child entities in the full hierarchy.
 */
