...
public abstract class HakijaryhmaValintatapajonoUtil {
  ...
  public static HakijaryhmaValintatapajono teeKopioMasterista(
      HakijaryhmaValintatapajono master, JuureenKopiointiCache kopiointiCache) {
    ...
    if (kopiointiCache == null) {
      ...
      Hakijaryhma kopioituHakijaryhma =
          kopiointiCache.kopioidutHakijaryhmat.get(master.getHakijaryhma().getId());
      if (kopioituHakijaryhma == null) {
        throw new IllegalStateException(
            "Ei löydetty lähde HakijaryhmaValintatapajonon  "
                + master
                + " hakijaryhmalle "
                + master.getHakijaryhma()
                + " kopiota");
      }
      kopio.setHakijaryhma(kopioituHakijaryhma);
      if (master.getMaster() != null) {
        HakijaryhmaValintatapajono kopioituMaster =
            kopiointiCache.kopioidutHakijaryhmaValintapajonot.get(master.getMaster().getId());
