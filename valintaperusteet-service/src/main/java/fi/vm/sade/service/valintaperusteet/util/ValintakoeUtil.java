...
public class ValintakoeUtil {
  public static Valintakoe teeKopioMasterista(
      Valintakoe master, JuureenKopiointiCache kopiointiCache) {
    ...
    if (kopiointiCache == null) {
      ...
      if (master.getLaskentakaavaId() != null) {
        kopio.setLaskentakaava(
            kopiointiCache.kopioidutLaskentakaavat.get(master.getLaskentakaavaId()));
      }
    }
