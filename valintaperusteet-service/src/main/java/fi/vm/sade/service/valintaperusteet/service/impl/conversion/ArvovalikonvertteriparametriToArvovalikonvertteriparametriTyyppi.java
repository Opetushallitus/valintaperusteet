 ...
 */
public class ArvovalikonvertteriparametriToArvovalikonvertteriparametriTyyppi implements Converter<Arvovalikonvertteriparametri, ArvovalikonvertteriparametriTyyppi> {
    ...
    public ArvovalikonvertteriparametriTyyppi convert(Arvovalikonvertteriparametri arvovalikonvertteriparametri) {
        ...
        tyyppi.setMaksimiarvo(arvovalikonvertteriparametri.getMaxValue());
        tyyppi.setMinimiarvo(arvovalikonvertteriparametri.getMinValue());
