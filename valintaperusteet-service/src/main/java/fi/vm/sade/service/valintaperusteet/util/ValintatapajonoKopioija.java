...
public class ValintatapajonoKopioija implements Kopioija<Valintatapajono> {
  ...
  public void kopioiTiedotMasteriltaKopiolle(
      Valintatapajono alkuperainenMaster, Valintatapajono paivitettyMaster, Valintatapajono kopio) {
    if (kopio.getAktiivinen().equals(alkuperainenMaster.getAktiivinen())) {
      kopio.setAktiivinen(paivitettyMaster.getAktiivinen());
    }
    if (kopio.getautomaattinenSijoitteluunSiirto() == null
        || kopio
            .getautomaattinenSijoitteluunSiirto()
            .equals(alkuperainenMaster.getautomaattinenSijoitteluunSiirto())) {
      kopio.setautomaattinenSijoitteluunSiirto(
          paivitettyMaster.getautomaattinenSijoitteluunSiirto());
    }
    if (kopio.getValisijoittelu() == null
        || kopio.getValisijoittelu().equals(alkuperainenMaster.getValisijoittelu())) {
    ...
    if (kopio
        ...
        .equals(alkuperainenMaster.getKaikkiEhdonTayttavatHyvaksytaan())) {
      kopio.setKaikkiEhdonTayttavatHyvaksytaan(
    ...
    if (kopio.getVarasijojaKaytetaanAlkaen() == null
        || kopio
            .getVarasijojaKaytetaanAlkaen()
            .equals(alkuperainenMaster.getVarasijojaKaytetaanAlkaen())) {
      kopio.setVarasijojaKaytetaanAlkaen(paivitettyMaster.getVarasijojaKaytetaanAlkaen());
    }
    if (kopio.getVarasijojaTaytetaanAsti() == null
        || kopio
            .getVarasijojaTaytetaanAsti()
            .equals(alkuperainenMaster.getVarasijojaTaytetaanAsti())) {
      kopio.setVarasijojaTaytetaanAsti(paivitettyMaster.getVarasijojaTaytetaanAsti());
    }
    if (kopio
        .getKaytetaanValintalaskentaa()
        .equals(alkuperainenMaster.getKaytetaanValintalaskentaa())) {
