...
public class LaskentakaavaServiceImpl implements LaskentakaavaService {
    ...
    public Funktiokutsu haeFunktiokutsuRekursiivisesti(final Long id, final boolean laajennaAlakaavat,
        ...
        // throw new FunktiokutsuEiOleOlemassaException("Funktiokutsu (" + id +
        // ") ei ole olemassa", id);
        // }
        //
        // for (Funktioargumentti fa : funktiokutsu.getFunktioargumentit()) {
        // if (fa.getFunktiokutsuChild() != null) {
        // haeFunktiokutsuRekursiivisesti(fa.getFunktiokutsuChild().getId(),
        ...
        // throw new FunktiokutsuMuodostaaSilmukanException("Funktiokutsu " + id
        // + " muodostaa silmukan " +
        ...
        //
        // Funktiokutsu fk =
        // haeFunktiokutsuRekursiivisesti(fa.getLaskentakaavaChild().getFunktiokutsu().getId(),
    ...
    private void haeValintaperusteetRekursiivisesti(Funktiokutsu funktiokutsu,
        ...
        for (ValintaperusteViite vp : funktiokutsu.getValintaperusteviitteet()) {
            if (Valintaperustelahde.SYOTETTAVA_ARVO.equals(vp.getLahde())
                ...
                valintaperuste.setFunktiotyyppi(modelMapper.map(funktiokutsu.getFunktionimi().getTyyppi(),
        ...
        for (Funktioargumentti arg : funktiokutsu.getFunktioargumentit()) {
            if (arg.getFunktiokutsuChild() != null) {
                haeHakukohteenValintaperusteetRekursiivisesti(
                        funktiokutsuDAO.getFunktiokutsu(arg.getFunktiokutsuChild().getId()), valintaperusteet);
            } else if (arg.getLaskentakaavaChild() != null) {
                haeHakukohteenValintaperusteetRekursiivisesti(
                        laskentakaavaDAO.getLaskentakaava(arg.getLaskentakaavaChild().getId()).getFunktiokutsu(),
                        valintaperusteet);
