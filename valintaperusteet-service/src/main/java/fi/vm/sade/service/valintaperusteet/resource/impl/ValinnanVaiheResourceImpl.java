...
public class ValinnanVaiheResourceImpl implements ValinnanVaiheResource {
  ...
  @Autowired ValintaryhmaService valintaryhmaService;

  @Autowired private ValintaperusteetModelMapper modelMapper;

  protected static final Logger LOGGER = LoggerFactory.getLogger(ValinnanVaiheResourceImpl.class);
  ...
  @ApiOperation(
      value = "Hakee valinnan vaiheen OID:n perusteella",
      response = ValinnanVaiheDTO.class)
  public ValinnanVaiheDTO read(
  ...
  @PreAuthorize(READ_UPDATE_CRUD)
  @ApiOperation(
      value = "Hakee valinnan vaiheen valintatapajonot OID:n perusteella",
  ...
  @PreAuthorize(READ_UPDATE_CRUD)
  @ApiOperation(
      value = "Hakee useiden valinnan vaiheiden valintatapajonot OIDien perusteella",
      response = ValintatapajonoDTO.class)
  public List<ValinnanVaiheJaValintatapajonoDTO> valintatapajonot(
      @ApiParam(value = "Valinnan vaiheiden OIDit", required = true)
          List<String> valinnanvaiheOidit) {
  ...
  @PreAuthorize(READ_UPDATE_CRUD)
  @ApiOperation(
      value = "Hakee valintakokeet valinnan vaiheen OID:n perusteella",
  ...
  public Response addJonoToValinnanVaihe(
      @ApiParam(value = "Valinnan vaiheen OID", required = true) @PathParam("parentOid")
          String parentOid,
  ...
  public ValinnanVaiheDTO update(
      @ApiParam(value = "Päivitettävän valinnan vaiheen OID", required = true) @PathParam("oid")
          String oid,
      @ApiParam(value = "Päivitettävän valinnan vaiheen uudet tiedot", required = true)
  ...
  @PreAuthorize(UPDATE_CRUD)
  @ApiOperation(
      value = "Järjestää valinnan vaiheet parametrina annetun OID-listan mukaiseen järjestykseen",
      response = ValinnanVaiheDTO.class)
  ...
  @PreAuthorize(READ_UPDATE_CRUD)
  @ApiOperation(
      value = "Palauttaa tiedon siitä, kuuluuko valinnan vaihe sijoitteluun",
  ...
  @PreAuthorize(READ_UPDATE_CRUD)
  @ApiOperation(
      value = "Palauttaa tiedon siitä, kuuluvatko valinnan vaiheet sijoitteluun",
      response = Boolean.class)
  public Map<String, Boolean> kuuluuSijoitteluun(
      @ApiParam(value = "Valinnan vaiheiden OID", required = true) List<String> oids) {
