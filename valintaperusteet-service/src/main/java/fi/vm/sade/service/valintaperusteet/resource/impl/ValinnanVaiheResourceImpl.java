...
public class ValinnanVaiheResourceImpl implements ValinnanVaiheResource {
	...
	protected final static Logger LOGGER = LoggerFactory
			.getLogger(ValinnanVaiheResourceImpl.class);
	...
	public ValinnanVaiheDTO read(
		...
		return modelMapper.map(valinnanVaiheService.readByOid(oid),
	...
	public List<ValintatapajonoDTO> listJonos(
		...
		return modelMapper.mapList(jonoService.findJonoByValinnanvaihe(oid),
	...
	public List<ValintakoeDTO> listValintakokeet(
		...
		return modelMapper.mapList(
				valintakoeService.findValintakoeByValinnanVaihe(oid),
				ValintakoeDTO.class);
	}
	...
	public Response addJonoToValinnanVaihe(
		...
		try {
			ValintatapajonoDTO inserted = modelMapper.map(jonoService
					.lisaaValintatapajonoValinnanVaiheelle(parentOid, jono,
							null), ValintatapajonoDTO.class);
			return Response.status(Response.Status.CREATED).entity(inserted)
					.build();
		} catch (Exception e) {
	...
	public Response addValintakoeToValinnanVaihe(
		...
		try {
			ValintakoeDTO vk = modelMapper.map(valintakoeService
					.lisaaValintakoeValinnanVaiheelle(parentOid, koe),
					ValintakoeDTO.class);
	...
	public ValinnanVaiheDTO update(
		...
		return modelMapper.map(valinnanVaiheService.update(oid, valinnanVaihe),
				ValinnanVaiheDTO.class);
	}
	...
	public List<ValinnanVaiheDTO> jarjesta(
		...
		return modelMapper.mapList(
				valinnanVaiheService.jarjestaValinnanVaiheet(oids),
				ValinnanVaiheDTO.class);
	}
