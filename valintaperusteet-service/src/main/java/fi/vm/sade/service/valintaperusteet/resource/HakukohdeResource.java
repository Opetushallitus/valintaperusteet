...
public class HakukohdeResource {
    ...
    public Response insert(@ApiParam(value = "Lisättävä hakukohde", required = true) HakukohdeViiteCreateDTO hakukohdeViiteDTO, @ApiParam("Valintaryhmän OID") String valintaryhmaOid) {
        try {
