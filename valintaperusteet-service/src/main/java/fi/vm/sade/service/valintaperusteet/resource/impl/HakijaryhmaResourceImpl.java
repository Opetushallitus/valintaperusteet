...
public class HakijaryhmaResourceImpl implements HakijaryhmaResource {
  ...
  protected static final Logger LOGGER = LoggerFactory.getLogger(HakijaryhmaResourceImpl.class);
  ...
  @ApiOperation(
      value = "Hakee hakijaryhmän OID:n perusteella",
      response = HakijaryhmaValintatapajonoDTO.class)
  @ApiResponses(
      value = {
        @ApiResponse(code = 404, message = "Hakijaryhmää ei löydy"),
      })
  public HakijaryhmaDTO read(
  ...
  public HakijaryhmaDTO update(
      @ApiParam(value = "Päivitettävän hakijaryhmän OID", required = true) @PathParam("oid")
          String oid,
      @ApiParam(value = "Hakijaryhmän uudet tiedot", required = true)
  ...
  public Response delete(
      @ApiParam(value = "Poistettavan hakijaryhmän OID", required = true) @PathParam("oid")
          String oid,
      @Context HttpServletRequest request) {
    try {
        ...
        .map(
            hakijaryhma ->
                Response.status(Response.Status.ACCEPTED)
                    .entity(modelMapper.map(hakijaryhma, HakijaryhmaDTO.class))
                    .build())
  ...
  @PreAuthorize(UPDATE_CRUD)
  @ApiOperation(
      value = "Järjestää hakijaryhmät parametrina annetun OID-listan mukaiseen järjestykseen",
