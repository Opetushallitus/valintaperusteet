  ...
  public void onReceive(Object message) throws Exception {
    if (message instanceof Funktiokutsu) {
      ...
      for (Funktioargumentti arg : original.getFunktioargumentit()) {
        if (arg.getFunktiokutsuChild() != null
          ...
          arg.setFunktiokutsuChild(response);
            ...
            && arg.getLaskentakaavaChild().getFunktiokutsu().getId().equals(response.getId())) {
          if (laskentakaavaIds.contains(arg.getLaskentakaavaChild().getId())) {
            silmukka =
                new FunktiokutsuMuodostaaSilmukanException(
                    "Funktiokutsu "
                        + id
                        + " muodostaa silmukan "
                        + "laskentakaavaan "
      ...
      if (original == null) {
        self()
            .tell(
                new FunktiokutsuEiOleOlemassaException(
        ...
        if (original.getFunktioargumentit() == null
          ...
          for (Funktioargumentti fa : original.getFunktioargumentit()) {
            ...
            if (fa.getFunktiokutsuChild() != null) {
              child.tell(
                  new UusiRekursio(
                      fa.getFunktiokutsuChild().getId(),
                      viesti.isLaajennaAlakaavat(),
              ...
              child.tell(
                  new UusiRekursio(
                      fa.getLaskentakaavaChild().getFunktiokutsu().getId(),
                      viesti.isLaajennaAlakaavat(),
                      newLaskentakaavaIds),
                  self());
      ...
      if (par.equals(actorParent)) {
        ...
        if (message instanceof FunktiokutsuMuodostaaSilmukanException) {
          FunktiokutsuMuodostaaSilmukanException exp =
              (FunktiokutsuMuodostaaSilmukanException) message;
          ex =
              new FunktiokutsuMuodostaaSilmukanException(
                  exp.getMessage(),
