...
public interface LaskentakaavaService {
  ...
  Optional<Laskentakaava> haeLaskentakaavaTaiSenKopioVanhemmilta(
      Long laskentakaavaId, HakukohdeViite ylaHakukohde);

  Optional<Laskentakaava> haeLaskentakaavaTaiSenKopioVanhemmilta(
      Long laskentakaavaId, Valintaryhma ylaValintaryhma);
