...
public class LukionValintaperusteet {
    ...
    public static Laskentakaava painotettuLukuaineidenKeskiarvoJaPaasykoe(Laskentakaava ka, Laskentakaava paasykoe) {
        ...
        return GenericHelper.luoLaskentakaavaJaNimettyFunktio(summa, "Lukion valintaperusteet, painotettu keskiarvo ja pääsykoe");
    }
    ...
    public static Laskentakaava painotettuLukuaineidenKeskiarvoJaLisanaytto(Laskentakaava ka, Laskentakaava lisanaytto) {
        ...
        return GenericHelper.luoLaskentakaavaJaNimettyFunktio(summa, "Lukion valintaperusteet, painotettu keskiarvo ja lisänäyttö");
    }
    ...
    public static Laskentakaava painotettuLukuaineidenKeskiarvoJaPaasykoeJaLisanaytto(Laskentakaava ka, Laskentakaava paasykoeJaLisanaytto) {
        ...
        return GenericHelper.luoLaskentakaavaJaNimettyFunktio(summa, "Lukion valintaperusteet, painotettu keskiarvo, pääsykoe ja lisänäyttö");
    }
    ...
    public static Laskentakaava painotettuLukuaineidenKeskiarvo() {
        ...
        for (String aine : LUKUAINEET) {
            ...
            Funktiokutsu arvo_kymppiluokka = GenericHelper.luoHaeLukuarvo(GenericHelper.luoValintaperusteViite(AINE_PREFIX + aine + KYMPPILUOKKA_SUFFIX, false, Valintaperustelahde.HAETTAVA_ARVO));
        ...
        for (String aine : KIELET) {
            for (String koodi : KIELIKOODIT) {
                ...
                Funktiokutsu arvo_kymppiluokka = GenericHelper.luoHaeLukuarvoEhdolla(GenericHelper.luoValintaperusteViite(AINE_PREFIX + aine + KYMPPILUOKKA_SUFFIX, false, Valintaperustelahde.HAETTAVA_ARVO), vp);
                Funktiokutsu max = GenericHelper.luoMaksimi(arvo, arvo_kymppiluokka);
        ...
        return GenericHelper.luoLaskentakaavaJaNimettyFunktio(GenericHelper.luoHylkaaArvovalilla(pyoristetty, "Lukion asettama keskiarvoraja ei ylity",
                "Uppnår inte av gymnasiet fastställda lägsta godkända medeltalsgräns", minimi, maksimi), "Lukion valintaperusteet, painotettu keskiarvo");
    }
    ...
    public static Laskentakaava paasykoeJaLisanaytto(Laskentakaava paasykoe, Laskentakaava lisanaytto) {
        ...
        return GenericHelper.luoLaskentakaavaJaNimettyFunktio(GenericHelper.luoHylkaaArvovalilla(summa, "Pääsykokeen ja lisänäytön alin hyväksyttävä yhteispistemäärä ei ylity",
                "Uppnår inte lägsta godkända sammanlagda poängantal för inträdesprov och tilläggsprestation", minimi, maksimi), "Lukion valintaperusteet, pääsykoe ja lisänäyttö");
    }
    ...
    public static Laskentakaava paasykoeLukuarvo(String paasykoeTunniste) {
        ...
        return GenericHelper.luoLaskentakaavaJaNimettyFunktio(GenericHelper.luoHylkaaArvovalilla(funktiokutsu, "Pääsykokeen alin hyväksyttävä pistemäärä ei ylity",
                "Uppnår inte lägsta godkända poängantal för inträdesprov", minimi, maksimi), "Lukion valintaperusteet, pääsykoe");
    }
    ...
    public static Laskentakaava lisanayttoLukuarvo(String lisanayttoTunniste) {
        ...
        kuvaukset.getTekstit().add(sv);
        Funktiokutsu funktiokutsu = GenericHelper.luoHaeLukuarvo(GenericHelper.luoValintaperusteViite(lisanayttoTunniste, true,
                Valintaperustelahde.HAKUKOHTEEN_SYOTETTAVA_ARVO, "Lisänäyttö", true, kuvaukset), konvs);
        return GenericHelper.luoLaskentakaavaJaNimettyFunktio(GenericHelper.luoHylkaaArvovalilla(funktiokutsu, "Lisänäytön alin hyväksyttävä pistemäärä ei ylity",
                "Uppnår inte lägsta godkända poängantal för tilläggsprestation", minimi, maksimi), "Lukion valintaperusteet, lisänäyttö");
    }
    ...
    public static Laskentakaava luoKaikkienAineidenKeskiarvo(LukionPkAineet pkAineet) {
        ...
        Laskentakaava laskentakaava = GenericHelper.luoLaskentakaavaJaNimettyFunktio(pyoristetty, "Kaikkien aineiden keskiarvo, lukiokoulutus");
