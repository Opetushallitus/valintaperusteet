...
public class PkJaYoPohjaiset {
  ...
  public static final String valtionhallinnonKielitutkintoPrefix =
      "valtionhallinnon_kielitutkinto_";
  ...
  public static final String peruskoulunPaattotodistusVahintaanSeitseman =
      "peruskoulun_paattotodistus_vahintaan_seitseman_";
  public static final String lukionPaattotodistusVahintaanSeitseman =
      "lukion_paattotodistus_vahintaan_seitseman_";
  ...
  public static final String urheilijanAmmatillisenKoulutuksenLisakysymysTunniste =
      "_urheilijan_ammatillisen_koulutuksen_lisakysymys";
  ...
  public static Laskentakaava luoHakutoivejarjestyspisteytysmalli() {
    ...
    Laskentakaava laskentakaava =
        GenericHelper.luoLaskentakaavaJaNimettyFunktio(
            jos, "Hakutoivejärjestyspisteytys, 2 aste, pk ja yo");
  ...
  public static Laskentakaava luoTyokokemuspisteytysmalli() {
    ...
    Funktiokutsu f =
        GenericHelper.luoHaeLukuarvo(
            GenericHelper.luoValintaperusteViite(
                tyokokemuskuukaudet, false, Valintaperustelahde.HAETTAVA_ARVO),
            0,
            Arrays.asList(konvs));
    ...
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        f, "Työkokemuspisteytys, 2 aste, pk ja yo");
  }
  ...
  public static Laskentakaava luoSukupuolipisteytysmalli() {
    ...
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        jos, "Sukupuolipisteytys, 2 aste, pk ja yo");
  }

  public static Laskentakaava luoYleinenKoulumenestysLaskentakaava(
      Laskentakaava laskentakaava,
      String nimi,
    ...
    konvertteri
        ...
        .add(GenericHelper.luoArvovalikonvertteriparametri(0.0, 5.50, 0));
    konvertteri
        .getArvovalikonvertteriparametrit()
    ...
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(7.75, 8.00, 10));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(8.00, 8.25, 11));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(8.25, 8.50, 12));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(8.50, 8.75, 13));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(8.75, 9.00, 14));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(9.00, 9.25, 15));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(9.25, 10.1, 16));
    ...
    Laskentakaava palautettavaLaskentakaava =
        GenericHelper.luoLaskentakaavaJaNimettyFunktio(konvertteri, nimi);
  ...
  public static Laskentakaava luoValintakoekaava(String nimi, Valintaperustelahde lahde) {
    ...
    ValintaperusteViite valintaperuste =
        GenericHelper.luoValintaperusteViite(
            nimi, true, lahde, "Pääsy- ja soveltuvuuskoe", false, kuvaukset);
  ...
  public static Laskentakaava luoValintakoekaava(
      String nimi, Valintaperustelahde lahde, boolean epasuoraViittaus) {
    ValintaperusteViite valintaperuste =
        GenericHelper.luoValintaperusteViite(
            nimi, true, lahde, "Pääsy- ja soveltuvuuskoe", epasuoraViittaus);
    List<Arvovalikonvertteriparametri> konvs = new ArrayList<Arvovalikonvertteriparametri>();
    konvs.add(GenericHelper.luoArvovalikonvertteriparametri(0.0, 10.0));
    Funktiokutsu funktiokutsu = GenericHelper.luoHaeLukuarvo(valintaperuste, konvs);
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
  ...
  public static Laskentakaava luoLisapistekaava(String tunniste) {
    ValintaperusteViite valintaperuste =
        GenericHelper.luoValintaperusteViite(
            tunniste, true, Valintaperustelahde.HAKUKOHTEEN_SYOTETTAVA_ARVO, "Lisäpiste", true);
    List<Arvovalikonvertteriparametri> konvs = new ArrayList<Arvovalikonvertteriparametri>();
    konvs.add(GenericHelper.luoArvovalikonvertteriparametri(0.0, 3.0));
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        GenericHelper.luoHaeLukuarvo(valintaperuste, konvs), "Ammatillinen koulutus, lisäpiste");
  }
  ...
  public static Laskentakaava luoUrheilijaLisapisteenMahdollisuus() {
      ...
      Funktiokutsu kutsu =
          GenericHelper.luoJa(
              GenericHelper.luoValintaperusteyhtasuuruus(
                  GenericHelper.luoValintaperusteViite(
                      preferenceTunniste + i + koulutusIdTunniste,
                      false,
                      Valintaperustelahde.HAETTAVA_ARVO,
                      "Hakukohteen OID hakemuksella"),
                  GenericHelper.luoValintaperusteViite(
                      hakukohteenOid,
                      true,
              ...
              GenericHelper.luoHaeTotuusarvo(
                  GenericHelper.luoValintaperusteViite(
                      preferenceTunniste + i + urheilijanAmmatillisenKoulutuksenLisakysymysTunniste,
                      false,
                      Valintaperustelahde.HAETTAVA_ARVO),
                  false));
      args[i - 1] = kutsu;
    ...
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        GenericHelper.luoTai(args), "Mahdollisuus urheilijalisäpisteeseen");
  }
  ...
  public static Laskentakaava luoKielikokeenPakollisuudenLaskentakaava() {
    Funktiokutsu[] args = {
      ...
      luoKielikoekriteeri8Funktiokutsu()
    };
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        GenericHelper.luoEi(GenericHelper.luoTai(args)),
  ...
  /**
   * 1) Hakijalla on perusopetuksen päästötodistus joka suoritettu vastaanottavan oppilaitoksen
   * opetuskielellä (suomi, ruotsi tai saame)
   */
  public static Funktiokutsu luoKielikoekriteeri1Funktiokutsu() {
    return GenericHelper.luoValintaperusteyhtasuuruus(
        GenericHelper.luoValintaperusteViite(
            opetuskieli, true, Valintaperustelahde.HAKUKOHTEEN_ARVO, "Opetuskieli", false),
        GenericHelper.luoValintaperusteViite(
            perustopetuksenKieli,
            false,
            Valintaperustelahde.HAETTAVA_ARVO,
            "Perusopetuksen kieli"));
  }

  /**
   * 2) Hakija on suorittanut vähintään arvosanalla 7 perusopetuksen toisen kotimaisen A-kielen
  ...
  public static Funktiokutsu luoKielikoekriteeri2Funktiokutsu() {
    ...
    class KriteeriGen {
      public Funktiokutsu luoKriteeri(final String ainetunniste) {
        Funktiokutsu oppiaineOnOpetuskieli =
            GenericHelper.luoValintaperusteyhtasuuruus(
                GenericHelper.luoValintaperusteViite(
                    opetuskieli, true, Valintaperustelahde.HAKUKOHTEEN_ARVO, "Opetuskieli", false),
                GenericHelper.luoValintaperusteViite(
                    PkAineet.oppiaine(ainetunniste),
                    false,
                    Valintaperustelahde.HAETTAVA_ARVO,
                    ainetunniste + " oppiaine"));
        Funktiokutsu arvosana =
            GenericHelper.luoHaeLukuarvo(
                GenericHelper.luoValintaperusteViite(
                    PkAineet.pakollinen(ainetunniste), false, Valintaperustelahde.HAETTAVA_ARVO),
                0.0);
        Funktiokutsu arvosana_kymppiluokka =
            GenericHelper.luoHaeLukuarvo(
                GenericHelper.luoValintaperusteViite(
                    PkAineet.kymppi(ainetunniste), false, Valintaperustelahde.HAETTAVA_ARVO),
                0.0);
        Funktiokutsu max = GenericHelper.luoMaksimi(arvosana, arvosana_kymppiluokka);
        Funktiokutsu arvosanaSuurempiKuin7 =
            GenericHelper.luoSuurempiTaiYhtasuuriKuin(max, seitseman);
  ...
  /**
   * 3) Hakija on suorittanut vähintään arvosanalla 7 perusopetuksen suomi tai ruotsi toisena
   * kielenä oppimäärän kielessä, joka on vastaanottavan oppilaitoksen opetuskieli
   */
  public static Funktiokutsu luoKielikoekriteeri3Funktiokutsu() {
    ...
    class KriteeriGen {
      public Funktiokutsu luoKriteeri(final String ainetunniste) {
        Funktiokutsu aidinkieliOnFiTaiSvToisenaKielena =
                ...
                GenericHelper.luoJa(
                    ...
                    GenericHelper.luoHaeMerkkijonoJaVertaaYhtasuuruus(
                        GenericHelper.luoValintaperusteViite(
                            ...
                            Valintaperustelahde.HAETTAVA_ARVO,
                            ainetunniste + " oppiaine"),
                        sv + toisenaKielenaPostfix,
                        false)));
        Funktiokutsu arvosanaAi =
            GenericHelper.luoHaeLukuarvo(
                GenericHelper.luoValintaperusteViite(
                    PkAineet.pakollinen(ainetunniste), false, Valintaperustelahde.HAETTAVA_ARVO),
                0);
        Funktiokutsu arvosanaAi_kymppiluokka =
            GenericHelper.luoHaeLukuarvo(
                GenericHelper.luoValintaperusteViite(
                    PkAineet.kymppi(ainetunniste), false, Valintaperustelahde.HAETTAVA_ARVO),
                0);
  ...
  /**
   * 4) Hakija on suorittanut lukion oppimäärän ylioppilastutkinnon vastaanottavan oppilaitoksen
   * opetuskielellä
   */
  public static Funktiokutsu luoKielikoekriteeri4Funktiokutsu() {
    return GenericHelper.luoValintaperusteyhtasuuruus(
        GenericHelper.luoValintaperusteViite(
            opetuskieli, true, Valintaperustelahde.HAKUKOHTEEN_ARVO, "Opetuskieli", false),
        GenericHelper.luoValintaperusteViite(
            lukionOppimaaranKieli,
            false,
            Valintaperustelahde.HAETTAVA_ARVO,
            "Lukion oppimäärän suorituskieli"));
  }

  /**
   * 5) hakija on suorittanut lukiokoulutuksen koko oppimäärän jossakin seuraavista äidinkieli,
   * kirjallisuus-oppiaineen oppimäärissä: suomi äidinkielenä, ruotsi äidinkielenä, suomi toisena
   * kielinä, ruotsi toisena kielienä, suomi saamenkielisille, suomi viittomakielisille, ruotsi
  ...
  public static Funktiokutsu luoKielikoekriteeri5Funktiokutsu() {
    ...
    class KriteeriGen {
      public Funktiokutsu luoKriteeri(final String ainetunniste) {
        Funktiokutsu opetuskieli =
            GenericHelper.luoTai(
                GenericHelper.luoJa(
                    GenericHelper.luoHaeMerkkijonoJaVertaaYhtasuuruus(
                        GenericHelper.luoValintaperusteViite(
                            PkJaYoPohjaiset.opetuskieli,
                            true,
                            Valintaperustelahde.HAKUKOHTEEN_ARVO,
                            "Opetuskieli",
                            false),
                    ...
                    GenericHelper.luoTai(
                        GenericHelper.luoHaeMerkkijonoJaVertaaYhtasuuruus(
                            GenericHelper.luoValintaperusteViite(
                                YoAineet.oppiaine(ainetunniste),
                                false,
                                Valintaperustelahde.HAETTAVA_ARVO),
                            fi,
                            false),
                    ...
                    GenericHelper.luoTai(
                        ...
                        GenericHelper.luoHaeMerkkijonoJaVertaaYhtasuuruus(
                            GenericHelper.luoValintaperusteViite(
                                ...
                                false,
                                Valintaperustelahde.HAETTAVA_ARVO),
                            sv + viittomakielisillePostfix,
                            false))));

        Funktiokutsu arvosanaSuurempiKuinViisi =
            GenericHelper.luoSuurempiTaiYhtasuuriKuin(
                GenericHelper.luoHaeLukuarvo(
                    GenericHelper.luoValintaperusteViite(
                        YoAineet.pakollinen(ainetunniste),
                        false,
                        Valintaperustelahde.HAETTAVA_ARVO),
                    0.0),
                viisi);
  ...
  /**
   * 6) Hakija on suorittanut lukiokoulutuksen toisen kotimaisen kielen koko oppimäärän joka on
    ...
    class KriteeriGen {
      public Funktiokutsu luoKriteeri(final String ainetunniste) {
        ...
        Funktiokutsu arvosana =
            GenericHelper.luoHaeLukuarvo(
                GenericHelper.luoValintaperusteViite(
                    YoAineet.pakollinen(ainetunniste), false, Valintaperustelahde.HAETTAVA_ARVO),
                0.0);
        Funktiokutsu arvosanaSuurempiKuin5 =
            GenericHelper.luoSuurempiTaiYhtasuuriKuin(arvosana, viisi);
  ...
  /**
   * 7) Hakija on suorittanut yleisten kielitutkintojen suomen tai ruotsin kielen tutkinnon kaikki
   * osakokeet vähintään taitotasolla 3 tai hakija on suorittanut valtionhallinnon kielitutkintojen
   * suomen tai ruotsin kielen suullisen ja kirjallisen taidon tutkinnon vähintään taitotasolla
   * tyydyttävä
   */
    ...
    return GenericHelper.luoTai(
        GenericHelper.luoJa(
            ...
            GenericHelper.luoTai(
                GenericHelper.luoHaeTotuusarvo(
                    GenericHelper.luoValintaperusteViite(
                        yleinenKielitutkintoPrefix + fi, false, Valintaperustelahde.HAETTAVA_ARVO),
                    false),
                GenericHelper.luoHaeTotuusarvo(
                    GenericHelper.luoValintaperusteViite(
                        valtionhallinnonKielitutkintoPrefix + fi,
                        false,
                        Valintaperustelahde.HAETTAVA_ARVO),
                    false))),
        GenericHelper.luoJa(
            ...
            GenericHelper.luoTai(
                GenericHelper.luoHaeTotuusarvo(
                    GenericHelper.luoValintaperusteViite(
                        yleinenKielitutkintoPrefix + sv, false, Valintaperustelahde.HAETTAVA_ARVO),
                    false),
                GenericHelper.luoHaeTotuusarvo(
                    GenericHelper.luoValintaperusteViite(
                        valtionhallinnonKielitutkintoPrefix + sv,
                        false,
                        Valintaperustelahde.HAETTAVA_ARVO),
                    false))));
  }
  ...
  /**
   * 8) PK Hakijan peruskoulun päättodistuksen tai LK hakijan lukion päättötodistuksen arvosana on
   * vähintään seitsemän hakukohteen opetuskielelle
   */
  public static Funktiokutsu luoKielikoekriteeri8Funktiokutsu() {
    ...
    return GenericHelper.luoTai(
        GenericHelper.luoJa(
            ...
            GenericHelper.luoHaeTotuusarvo(
                GenericHelper.luoValintaperusteViite(
                    peruskoulunPaattotodistusVahintaanSeitseman + fi,
                    false,
                    Valintaperustelahde.HAETTAVA_ARVO),
                false)),
        GenericHelper.luoJa(
            ...
            GenericHelper.luoHaeTotuusarvo(
                GenericHelper.luoValintaperusteViite(
                    peruskoulunPaattotodistusVahintaanSeitseman + sv,
                    false,
                    Valintaperustelahde.HAETTAVA_ARVO),
                false)),
        GenericHelper.luoJa(
            ...
            GenericHelper.luoHaeTotuusarvo(
                GenericHelper.luoValintaperusteViite(
                    peruskoulunPaattotodistusVahintaanSeitseman + se,
                    false,
                    Valintaperustelahde.HAETTAVA_ARVO),
                false)),
        GenericHelper.luoJa(
            ...
            GenericHelper.luoHaeTotuusarvo(
                GenericHelper.luoValintaperusteViite(
                    peruskoulunPaattotodistusVahintaanSeitseman + vk,
                    false,
                    Valintaperustelahde.HAETTAVA_ARVO),
                false)),
        GenericHelper.luoJa(
            ...
            GenericHelper.luoHaeTotuusarvo(
                GenericHelper.luoValintaperusteViite(
                    lukionPaattotodistusVahintaanSeitseman + fi,
                    false,
                    Valintaperustelahde.HAETTAVA_ARVO),
                false)),
        GenericHelper.luoJa(
            ...
            GenericHelper.luoHaeTotuusarvo(
                GenericHelper.luoValintaperusteViite(
                    lukionPaattotodistusVahintaanSeitseman + sv,
                    false,
                    Valintaperustelahde.HAETTAVA_ARVO),
                false)),
        GenericHelper.luoJa(
            ...
            GenericHelper.luoHaeTotuusarvo(
                GenericHelper.luoValintaperusteViite(
                    lukionPaattotodistusVahintaanSeitseman + se,
                    false,
                    Valintaperustelahde.HAETTAVA_ARVO),
                false)),
        GenericHelper.luoJa(
            ...
            GenericHelper.luoHaeTotuusarvo(
                GenericHelper.luoValintaperusteViite(
                    lukionPaattotodistusVahintaanSeitseman + vk,
                    false,
                    Valintaperustelahde.HAETTAVA_ARVO),
                false)));
  }

  public static Laskentakaava luoYhdistettyPeruskaavaJaKielikoekaava(
      Laskentakaava peruskaava, Laskentakaava kielikoekaava) {
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        GenericHelper.luoSumma(
            peruskaava,
            GenericHelper.luoHylkaa(
                kielikoekaava, "Hylätty kielikoetulos", "Underkänd i språkprov")),
        peruskaava.getNimi() + " + " + kielikoekaava.getNimi());
  }

  public static Laskentakaava luoYhdistettyPeruskaavaJaLisapistekaava(
      Laskentakaava peruskaava, Laskentakaava lisapistekaava) {
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        GenericHelper.luoSumma(peruskaava, lisapistekaava),
        peruskaava.getNimi() + " + " + lisapistekaava.getNimi());
  }

  public static Laskentakaava luoYhdistettyPeruskaavaJaValintakoekaava(
      Laskentakaava peruskaava, Laskentakaava valintakoekaava) {
    Funktiokutsu yhdistetty = GenericHelper.luoSumma(peruskaava, valintakoekaava);
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        yhdistetty, peruskaava.getNimi() + " + " + valintakoekaava.getNimi());
  }

  /**
   * Ulkomailla suoritetulla pohjakoulutuksella tai oppivelvollisuuden suorittamisen keskeyttäneitä
   * hakijoita ei kutsuta valinta-/kielikokeeseen.
   */
  public static Laskentakaava
      luoUlkomaillaSuoritettuKoulutusTaiOppivelvollisuudenSuorittaminenKeskeytynyt() {
    Funktiokutsu ulkomaillaSuoritettuKoulutus =
        GenericHelper.luoHaeMerkkijonoJaVertaaYhtasuuruus(
            GenericHelper.luoValintaperusteViite(
                PkPohjaiset.pohjakoulutusAvain, false, Valintaperustelahde.HAETTAVA_ARVO),
            PkPohjaiset.ulkomaillaSuoritettuKoulutus,
            Boolean.FALSE);

    Funktiokutsu oppivelvollisuudenSuorittaminenKeskeytynyt =
        GenericHelper.luoHaeMerkkijonoJaVertaaYhtasuuruus(
            GenericHelper.luoValintaperusteViite(
                PkPohjaiset.pohjakoulutusAvain, false, Valintaperustelahde.HAETTAVA_ARVO),
    ...
    Funktiokutsu tai =
        GenericHelper.luoTai(
            ulkomaillaSuoritettuKoulutus, oppivelvollisuudenSuorittaminenKeskeytynyt);
    Funktiokutsu hylkaa =
        GenericHelper.luoHylkaa(
            tai,
            "Hylätty harkinnanvaraisessa valinnassa",
            "Ej godkänd i antagning enligt prövning");
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        hylkaa,
        "Ulkomailla suoritettu koulutus tai " + "oppivelvollisuuden suorittaminen keskeytynyt");
  }

  public static Laskentakaava luoPoikkeavanValintaryhmanLaskentakaava(
      Laskentakaava valintakoekaava, Laskentakaava kielikoekaava) {
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        GenericHelper.luoSumma(
            valintakoekaava,
            GenericHelper.luoHylkaa(
    ...
    Funktiokutsu funktiokutsu =
        GenericHelper.luoHaeLukuarvo(
            GenericHelper.luoValintaperusteViite(
                ...
                false,
                Valintaperustelahde.HAKUKOHTEEN_SYOTETTAVA_ARVO,
                "Urheilijan lisäpiste",
                true),
            0,
            konvs);
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        funktiokutsu, "Urheilijalisäpisteen laskentakaava");
  }

  public static Laskentakaava luoHakutoivejarjestysTasapistekaava() {
    return YhteisetKaavat.luoHakutoivejarjestysTasapistekaava(
