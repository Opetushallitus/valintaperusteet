...
public class ValintaperusteServiceImpl implements ValintaperusteService {
	...
	private ValintaperusteetTyyppi convertValintaperusteet(
		...
		case VALINTAKOE:
			...
			valintakoe.getValintakoe().addAll(
	...
	private List<ValintakoeTyyppi> convertValintakokeet(
	...
	private List<ValintatapajonoJarjestyskriteereillaTyyppi> convertJonot(
			ValinnanVaihe valinnanVaihe) {
		...
		for (int prioriteetti = 0; prioriteetti < jonot.size(); prioriteetti++) {
			...
			tyyppi.setSiirretaanSijoitteluun(valintatapajono
					.getSiirretaanSijoitteluun());

            tyyppi.setEiVarasijatayttoa(valintatapajono.getEiVarasijatayttoa());
            tyyppi.setKaytetaanValintalaskentaa(valintatapajono.getKaytetaanValintalaskentaa());
			...
			tyyppi.getJarjestyskriteerit().addAll(
	...
	private List<JarjestyskriteeriTyyppi> convertJarjestyskriteerit(
