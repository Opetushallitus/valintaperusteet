...
public class PkPohjaiset {
  ...
  public static final String vammaistenValmentavaJaKuntouttavaOpetusJaOhjaus =
      "LISAKOULUTUS_VAMMAISTEN";
  public static final String maahanmuuttajienAmmatilliseenPeruskoulutukseenValmistavaKoulutus =
  ...
  public static final String kansanopistonLukuvuodenMittainenLinjaAmmatilliseenPeruskoulutukseen =
      "LISAKOULUTUS_KANSANOPISTO";
  public static final String koulutuspaikkaAmmatilliseenTutkintoon =
      "KOULUTUSPAIKKA_AMMATILLISEEN_TUTKINTOON";

  public static final String[] lisapistekoulutus = {
    kymppiluokka,
    vammaistenValmentavaJaKuntouttavaOpetusJaOhjaus,
    maahanmuuttajienAmmatilliseenPeruskoulutukseenValmistavaKoulutus,
    talouskoulu,
    ammattistartti,
  ...
  public static Laskentakaava luoPohjakoulutuspisteytysmalli() {
      ...
      vertailut.add(
          GenericHelper.luoHaeMerkkijonoJaVertaaYhtasuuruus(
              GenericHelper.luoValintaperusteViite(
                  pohjakoulutusAvain, false, Valintaperustelahde.HAETTAVA_ARVO),
              arvo,
              false));
    }
    Funktiokutsu pohjakoulutusOnPeruskoulutus =
        GenericHelper.luoTai(vertailut.toArray(new FunktionArgumentti[vertailut.size()]));
    // Todistuksen saantivuosi -->
    Funktiokutsu haeTodistuksenSaantivuosi =
        GenericHelper.luoHaeLukuarvo(
            GenericHelper.luoValintaperusteViite(
                todistuksenSaantivuosi, false, Valintaperustelahde.HAETTAVA_ARVO),
            -1);
    Funktiokutsu todistuksenSaantivuosiOnSamaKuinKuluvavuosi =
        GenericHelper.luoYhtasuuri(
            GenericHelper.luoLukuarvo(kuluvaVuosi), haeTodistuksenSaantivuosi);
    Funktiokutsu ja =
        GenericHelper.luoJa(
            pohjakoulutusOnPeruskoulutus, todistuksenSaantivuosiOnSamaKuinKuluvavuosi);
    ...
    for (String tunniste : lisapistekoulutus) {
      args.add(
          GenericHelper.luoHaeTotuusarvo(
              GenericHelper.luoValintaperusteViite(
                  tunniste, false, Valintaperustelahde.HAETTAVA_ARVO),
              false));
    }
    ...
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        jos, "Pohjakoulutuspisteytys, 2 aste, pk");
  }
  ...
  public static Laskentakaava luoToisenAsteenPeruskoulupohjainenPeruskaava(
      ...
      Laskentakaava pohjakoulutuspisteytysmalli,
      Laskentakaava ilmanKoulutuspaikkaaPisteytysmalli,
    ...
    Funktiokutsu summa =
        GenericHelper.luoSumma(
            painotettavatKeskiarvotLaskentakaava,
            yleinenkoulumenestyspisteytysmalli,
            pohjakoulutuspisteytysmalli,
            ilmanKoulutuspaikkaaPisteytysmalli,
            hakutoivejarjestyspisteytysmalli,
            tyokokemuspisteytysmalli,
            sukupuolipisteytysmalli,
            urheilijanLisapiste);
    return GenericHelper.luoLaskentakaavaJaNimettyFunktio(
        summa, "2. asteen peruskoulupohjainen peruskaava");
  }
  ...
  public static Laskentakaava ilmanKoulutuspaikkaaPisteytysmalli() {
    ...
    Funktiokutsu ehto =
        GenericHelper.luoEi(
            GenericHelper.luoHaeTotuusarvo(
                GenericHelper.luoValintaperusteViite(
                    koulutuspaikkaAmmatilliseenTutkintoon,
                    false,
  ...
  public static Laskentakaava luoPainotettavatKeskiarvotLaskentakaavaIlmanKonvertteria(
      PkAineet pkAineet) {
    Laskentakaava[] args =
        new Laskentakaava[] {
    ...
    Laskentakaava laskentakaava =
        GenericHelper.luoLaskentakaavaJaNimettyFunktio(
            kolmeParasta, "Painotettavien arvosanojen keskiarvo");
  ...
  public static Laskentakaava luoPainotettavatKeskiarvotLaskentakaava(Laskentakaava keskiarvot) {
    ...
    konvertteri
        ...
        .add(GenericHelper.luoArvovalikonvertteriparametri(0.0, 6.0, 0));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(6.0, 6.5, 1));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(6.5, 7.0, 2));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(7.0, 7.5, 3));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(7.5, 8.0, 4));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(8.0, 8.5, 5));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(8.5, 9.0, 6));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(9.0, 9.5, 7));
    konvertteri
        .getArvovalikonvertteriparametrit()
        .add(GenericHelper.luoArvovalikonvertteriparametri(9.5, 10.1, 8));
    ...
    Laskentakaava laskentakaava =
        GenericHelper.luoLaskentakaavaJaNimettyFunktio(
            konvertteri, "Painotettavat arvosanat pisteytysmalli, PK");
    return laskentakaava;
  }

  public static Laskentakaava luoPKPohjaisenKoulutuksenKaikkienAineidenKeskiarvo(
      PkAineet pkAineet) {
    Laskentakaava[] args =
        new Laskentakaava[] {
