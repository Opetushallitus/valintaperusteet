...
public class GenericHelper {
  ...
  public static ValintaperusteViite luoValintaperusteViite(
      String tunniste, boolean onPakollinen, Valintaperustelahde lahde) {
    return luoValintaperusteViite(tunniste, onPakollinen, lahde, "");
  }

  public static ValintaperusteViite luoValintaperusteViite(
      String tunniste, boolean onPakollinen, Valintaperustelahde lahde, String kuvaus) {
  ...
  public static Funktiokutsu luoHaeLukuarvoEhdolla(
      ValintaperusteViite vp, ValintaperusteViite ehto) {
    Funktiokutsu funktiokutsu = new Funktiokutsu();
  ...
  public static Funktiokutsu luoHaeLukuarvo(ValintaperusteViite vp, double oletusarvo) {
    ...
    funktiokutsu
        .getSyoteparametrit()
        .add(luoSyoteparametri("oletusarvo", String.valueOf(oletusarvo)));
    return funktiokutsu;
  }
  ...
  public static Funktiokutsu luoJosFunktio(
      Funktiokutsu ehto, Funktiokutsu totta, Funktiokutsu vale) {
  ...
  public static Laskentakaava luoLaskentakaavaJaNimettyFunktio(
      Funktiokutsu funktiokutsu, String nimi) {
    Funktiokutsu nimetty = luoNimettyFunktio(funktiokutsu, nimi);
    return luoLaskentakaava(nimetty, nimi);
  }

  public static Arvovalikonvertteriparametri luoArvovalikonvertteriparametri(
      double min, double max, double paluuarvo) {
  ...
  public static Arvokonvertteriparametri luoArvokonvertteriparametri(
      String arvo, String paluuarvo, boolean hylkaysperuste) {
  ...
  public static Funktiokutsu luoHaeMerkkijonoJaKonvertoiLukuarvoksi(
      ValintaperusteViite vp, Collection<Arvokonvertteriparametri> arvokonvertterit) {
    Funktiokutsu funktiokutsu = new Funktiokutsu();
  ...
  public static Funktiokutsu luoDemografia(String tunniste, double prosenttiosuus) {
    ...
    funktiokutsu
        .getSyoteparametrit()
        .add(luoSyoteparametri("prosenttiosuus", String.valueOf(prosenttiosuus)));
    return funktiokutsu;
  }
  ...
  public static Funktiokutsu luoHaeLukuarvo(
      ValintaperusteViite vp, Collection<Arvovalikonvertteriparametri> konvs) {
    Funktiokutsu funktiokutsu = luoHaeLukuarvo(vp);
  ...
  public static Funktiokutsu luoHaeLukuarvo(
      ValintaperusteViite vp, double oletusarvo, Collection<Arvovalikonvertteriparametri> konvs) {
  ...
  public static Funktiokutsu luoHaeMerkkijonoJaKonvertoiTotuusarvoksi(
      ValintaperusteViite vp, boolean oletusarvo, Collection<Arvokonvertteriparametri> konvs) {
  ...
  public static Funktiokutsu luoHaeMerkkijonoJaKonvertoiTotuusarvoksi(
      ValintaperusteViite vp, Collection<Arvokonvertteriparametri> konvs) {
    Funktiokutsu funktiokutsu = new Funktiokutsu();
  ...
  public static Funktiokutsu luoHaeMerkkijonoJaVertaaYhtasuuruus(
      ValintaperusteViite vp, String vertailtava, boolean oletusarvo) {
  ...
  public static Funktiokutsu luoHaeMerkkijonoJaVertaaYhtasuuruus(
      ValintaperusteViite vp, String vertailtava) {
    Funktiokutsu f = new Funktiokutsu();
  ...
  public static Funktiokutsu luoSuurempiTaiYhtasuuriKuin(
      FunktionArgumentti f1, FunktionArgumentti f2) {
    Funktiokutsu f = new Funktiokutsu();
  ...
  public static Funktiokutsu luoHylkaa(
      FunktionArgumentti arg, String hylkaysperustekuvaus, String hylkaysperustekuvaus_sv) {
    Funktiokutsu f = new Funktiokutsu();
    ...
    f.getSyoteparametrit()
        .add(luoSyoteparametri("hylkaysperustekuvaus_SV", hylkaysperustekuvaus_sv));
    return f;
  }

  public static Funktiokutsu luoHylkaaArvovalilla(
      FunktionArgumentti arg,
      String hylkaysperustekuvaus,
      String hylkaysperustekuvaus_sv,
      String min,
      String max) {
    Funktiokutsu f = new Funktiokutsu();
  ...
  public static Funktiokutsu luoValintaperusteyhtasuuruus(
      ValintaperusteViite vp1, ValintaperusteViite vp2) {
    Funktiokutsu fk = new Funktiokutsu();
