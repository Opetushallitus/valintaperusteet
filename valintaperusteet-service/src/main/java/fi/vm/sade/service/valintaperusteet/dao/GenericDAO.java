...
public interface GenericDAO {
  ...
  /**
   * Lists all objects of given type with the matching field value from database
   *
   * @param entity
   * @param column
   * @param value
  ...
  /**
   * Perform entity level validation when needed. For example two date fields which are dependant.
   *
   * @param entity
   */
