...
public abstract class ValinnanVaiheUtil {
    public static ValinnanVaihe teeKopioMasterista(ValinnanVaihe master, JuureenKopiointiCache kopiointiCache) {
        ...
        if(kopiointiCache == null) {
            ...
            if(master.getMaster() != null) {
                ValinnanVaihe kopioituMaster = kopiointiCache.kopioidutValinnanVaiheet.get(master.getMaster().getId());
                if (kopioituMaster == null) {
                    throw new IllegalStateException("Ei löydetty lähdevaiheen " + master + " masterille " + master.getMaster() + " kopiota");
                }
