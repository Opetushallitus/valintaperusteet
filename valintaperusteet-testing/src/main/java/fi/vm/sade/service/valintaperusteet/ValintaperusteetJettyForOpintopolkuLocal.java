 ...
 *
 * <p>Normaali käyttö: https://github.com/Opetushallitus/local-environment
 */
public class ValintaperusteetJettyForOpintopolkuLocal extends OpintopolkuJetty {
  public static final int port =
      Integer.parseInt(System.getProperty("valintaperusteet-service.port", "8081"));
  ...
  private void start() throws IOException {
    ...
    webAppContext.setBaseResource(
        Resource.newResource("./valintaperusteet-service/target/classes/webapp"));
