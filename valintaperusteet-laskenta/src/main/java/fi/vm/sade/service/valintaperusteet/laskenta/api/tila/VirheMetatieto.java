...
@JsonSubTypes({
  @JsonSubTypes.Type(
      value = OsallistumistietoaEiVoidaTulkitaVirhe.class,
      name = "OsallistumistietoaEiVoidaTulkitaVirhe"),
  @JsonSubTypes.Type(
      value = ValintaperustettaEiVoidaTulkitaTotuusarvoksiVirhe.class,
      name = "ValintaperustettaEiVoidaTulkitaTotuusarvoksiVirhe"),
  @JsonSubTypes.Type(
      value = ValintaperustettaEiVoidaTulkitaLukuarvoksiVirhe.class,
      name = "ValintaperustettaEiVoidaTulkitaLukuarvoksiVirhe"),
  ...
  @JsonSubTypes.Type(
      value = SyotettavaArvoMerkitsemattaVirhe.class,
      name = "SyotettavaArvoMerkitsemattaVirhe"),
  @JsonSubTypes.Type(
      value = HakukohteenValintaperusteMaarittelemattaVirhe.class,
      name = "HakukohteenValintaperusteMaarittelemattaVirhe"),
  @JsonSubTypes.Type(
      value = VirheellinenLaskentamoodiVirhe.class,
      name = "VirheellinenLaskentamoodiVirhe"),
  @JsonSubTypes.Type(
      value = SkaalattavaArvoEiOleLahdeskaalassaVirhe.class,
      name = "SkaalattavaArvoEiOleLahdeskaalassaVirhe"),
  @JsonSubTypes.Type(
      value = TuloksiaLiianVahanLahdeskaalanMaarittamiseenVirhe.class,
      name = "TuloksiaLiianVahanLahdeskaalanMaarittamiseenVirhe")
})
public abstract class VirheMetatieto {
  ...
  public static enum VirheMetatietotyyppi {
    ...
    VALINTAPERUSTETTA_EI_VOIDA_TULKITA_TOTUUSARVOKSI(
        ValintaperustettaEiVoidaTulkitaTotuusarvoksiVirhe.class),
    VALINTAPERUSTETTA_EI_VOIDA_TULKITA_LUKUARVOKSI(
        ValintaperustettaEiVoidaTulkitaLukuarvoksiVirhe.class),
    ...
    HAKUKOHTEEN_VALINTAPERUSTE_MAARITTELEMATTA_VIRHE(
        HakukohteenValintaperusteMaarittelemattaVirhe.class),
    ...
    TULOKSIA_LIIAN_VAHAN_LAHDESKAALAN_MAARITTAMISEEN(
        TuloksiaLiianVahanLahdeskaalanMaarittamiseenVirhe.class);
