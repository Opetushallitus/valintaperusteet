...
/**
 * User: kwuoti Date: 28.2.2013 Time: 12.36
 */
public class FunktioargumentinLaskentakaavaVaaranTyyppinenVirhe extends Validointivirhe {

    public FunktioargumentinLaskentakaavaVaaranTyyppinenVirhe(String virheviesti, int indeksi,
            Funktiotyyppi vaadittuTyyppi, Funktiotyyppi annettuTyyppi) {
