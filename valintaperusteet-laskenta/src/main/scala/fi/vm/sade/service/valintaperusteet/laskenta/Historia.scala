...
case class Historia(funktio: String,
...
object Historia {
  def apply(funktioNimi: Funktionimi, tulos: Option[Any], tilat: List[Tila], historiat: Option[List[Historia]], avaimet: Option[Map[String, Option[Any]]]): Historia = {
    Historia(funktioNimi.getKuvaus, Some(funktioNimi), tulos, tilat, historiat, avaimet)
  }

  def apply(funktio: String, tulos: Option[Any], tilat: List[Tila], historiat: Option[List[Historia]], avaimet: Option[Map[String, Option[Any]]]): Historia = {
