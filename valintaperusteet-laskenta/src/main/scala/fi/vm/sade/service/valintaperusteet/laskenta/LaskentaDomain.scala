...
object LaskentaDomain {
  ...
  case class SyotettavaValintaperuste(
    tunniste: String,
    pakollinen: Boolean,
    osallistuminenTunniste: String,
    kuvaus: String = "",
    kuvaukset: TekstiRyhma,
    vaatiiOsallistumisen: Boolean = true,
    syotettavissaKaikille: Boolean = true,
    tyypinKoodiUri: Option[String] = None,
    tilastoidaan: Boolean = false,
    ammatillisenKielikoeOsallistuminenSpecialHandling: Boolean = false
  ) extends Valintaperuste

  case class HakukohteenValintaperuste(
    tunniste: String,
    pakollinen: Boolean,
    epasuoraViittaus: Boolean
  ) extends Valintaperuste

  case class HakukohteenSyotettavaValintaperuste(
    tunniste: String,
    pakollinen: Boolean,
    epasuoraViittaus: Boolean,
    osallistuminenTunniste: String,
  ...
  def tekstiryhmaToMap(ryhma: TekstiRyhma): java.util.Map[String, String] = {
    if (ryhma != null && ryhma.getTekstit != null) {
      ...
      val res = tekstit.foldLeft(Map.empty[String, String]) {
        (result: Map[String, String], teksti: LokalisoituTeksti) =>
          result + (teksti.getKieli.name -> teksti.getTeksti)
      }
      res.asJava
    } else {
      ...
      konversiot.filter(arvo == _.arvo) match {
        case Nil =>
          (
            None,
            new Virhetila(
              tekstiToMap(s"Arvo $arvo ei täsmää yhteenkään konvertterille määritettyyn arvoon"),
        ...
        case head :: _ =>
          ...
          val tila = if (head.hylkaysperuste) {
            new Hylattytila(
              tekstiryhmaToMap(head.kuvaukset),
              new Arvokonvertterihylkays(arvo.toString),
              "Arvokonvertterin konvertoi metodissa suoritettu hylkays."
            )
  ...
  case class Lukuarvovalikonvertteri(konversioMap: Seq[Konversio])
      extends Konvertteri[BigDecimal, BigDecimal] {
      ...
      konversiot
        ...
        case Nil =>
          (
            ...
            new Virhetila(
              tekstiToMap(
                s"Arvo $arvo ei täsmää yhteenkään konvertterille määritettyyn arvoväliin"
              ),
        ...
        case head :: _ =>
          ...
          val tila = if (head.hylkaysperuste) {
            new Hylattytila(
              tekstiryhmaToMap(head.kuvaukset),
              new Arvovalikonvertterihylkays(
                arvo.underlying,
                head.min.underlying,
                head.max.underlying
              ),
  ...
  case class Arvokonversio[S, T](
    arvo: S,
    paluuarvo: T,
    hylkaysperuste: Boolean,
    kuvaukset: TekstiRyhma
  ) extends Konversio

  case class ArvokonversioMerkkijonoilla[S, T](
    arvo: String,
    paluuarvo: T,
  ...
  case class Lukuarvovalikonversio(
    min: BigDecimal,
    max: BigDecimal,
    paluuarvo: BigDecimal,
    palautaHaettuArvo: Boolean,
    hylkaysperuste: Boolean,
    kuvaukset: TekstiRyhma
  ) extends Konversio

  case class LukuarvovalikonversioMerkkijonoilla(
    min: String,
    max: String,
    paluuarvo: String,
    palautaHaettuArvo: String,
    hylkaysperuste: String,
    kuvaukset: TekstiRyhma
  ) extends Konversio
  ...
  ) extends KonvertoivaFunktio[BigDecimal, BigDecimal]
      with Lukuarvofunktio
  ...
  case class Summa(
    ...
    tulosTekstiEn: String = "",
    omaopintopolku: Boolean = false
  ) extends KoostavaFunktio[BigDecimal]
      with Lukuarvofunktio
  ...
  object HaeArvo {
    def unapply(ha: HaeArvo[_]): Option[(Option[_], Valintaperuste)] =
      Some((ha.oletusarvo, ha.valintaperusteviite))
  }
  ...
  case class HaeYoArvosana(
    ...
    tulosTekstiEn: String = "",
    omaopintopolku: Boolean = false
  ) extends HaeArvo[BigDecimal]
      with Lukuarvofunktio

  case class HaeYoPisteet(
  ...
  case class IteroiAmmatillisetTutkinnot(
  ...
  case class HaeAmmatillisenTutkinnonYtoOsaAlueenArvosana(
    ...
    override val iteraatioParametrinTyyppi: Option[Class[_ <: IteraatioParametri]] = Some(
  ...
  case class HaeAmmatillinenYtoArvosana(
    konvertteri: Option[Konvertteri[BigDecimal, BigDecimal]],
    oletusarvo: Option[BigDecimal],
    valintaperusteviite: Valintaperuste,
    oid: String = "",
  ...
  case class HaeAmmatillinenYtoArviointiAsteikko(
    konvertteri: Konvertteri[String, BigDecimal],
    oletusarvo: Option[BigDecimal],
    valintaperusteviite: Valintaperuste,
    oid: String = "",
  ...
  case class HaeMerkkijonoJaKonvertoiLukuarvoksi(
    konvertteri: Konvertteri[String, BigDecimal],
    oletusarvo: Option[BigDecimal],
    valintaperusteviite: Valintaperuste,
    oid: String = "",
  ...
  case class HaeTotuusarvoJaKonvertoiLukuarvoksi(
  ...
  case class HaeMerkkijonoJaKonvertoiTotuusarvoksi(
    ...
    tulosTekstiEn: String = "",
    omaopintopolku: Boolean = false
  ) extends HaeArvo[Boolean]
      with Totuusarvofunktio

  case class HaeTotuusarvo(
  ...
  case class HaeMerkkijonoJaVertaaYhtasuuruus(
    oletusarvo: Option[Boolean],
    valintaperusteviite: Valintaperuste,
    vertailtava: String,
    oid: String = "",
  ...
  case class Ja(
    ...
    tulosTekstiEn: String = "",
    omaopintopolku: Boolean = false
  ) extends KoostavaFunktio[Boolean]
      with Totuusarvofunktio
  ...
  case class Skaalaus(
    ...
    tulosTekstiEn: String = "",
    omaopintopolku: Boolean = false,
    skaalattava: Lukuarvofunktio,
    kohdeskaala: Tuple2[BigDecimal, BigDecimal],
    lahdeskaala: Option[Tuple2[BigDecimal, BigDecimal]]
  ) extends Lukuarvofunktio {
    require(
      kohdeskaala._1 < kohdeskaala._2,
      "Kohdeskaalan minimin pitää olla pienempi kuin maksimi"
    )
    require(
      lahdeskaala.isEmpty || lahdeskaala.get._1 < lahdeskaala.get._2,
  ...
  case class Valintaperusteyhtasuuruus(
    ...
    tulosTekstiEn: String = "",
    omaopintopolku: Boolean = false,
    valintaperusteet: Tuple2[Valintaperuste, Valintaperuste]
  ) extends Totuusarvofunktio
