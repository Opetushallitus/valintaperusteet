...
class LaskentakaavavalidaattoriTest extends AnyFunSuite {
  ...
  val validiLukuarvo1 = Funktiokutsu(
    ...
    syoteparametrit = List(Syoteparametri(avain = "luku", arvo = "-123.0"))
  )

  val validiLukuarvo2 = Funktiokutsu(
    nimi = Funktionimi.LUKUARVO,
    syoteparametrit = List(Syoteparametri(avain = "luku", arvo = "100.0"))
  )

  val validiLukuarvo3 = Funktiokutsu(
    nimi = Funktionimi.LUKUARVO,
    syoteparametrit = List(Syoteparametri(avain = "luku", arvo = "3.335"))
  )

  val validiTotuusarvo1 = Funktiokutsu(
    nimi = Funktionimi.TOTUUSARVO,
    syoteparametrit = List(Syoteparametri(avain = "totuusarvo", arvo = "false"))
  )

  val validiTotuusarvo2 = Funktiokutsu(
    nimi = Funktionimi.TOTUUSARVO,
    syoteparametrit = List(Syoteparametri(avain = "totuusarvo", arvo = "true"))
  )
  ...
  test("Lukuarvo without input parameters") {
    val funktiokutsu = Funktiokutsu(nimi = Funktionimi.LUKUARVO)
  ...
  test("Lukuarvo with incorrect input parameters") {
    val funktiokutsu = Funktiokutsu(
      nimi = Funktionimi.LUKUARVO,
      syoteparametrit = List(Syoteparametri(avain = "puuppa", arvo = "123.0"))
    )
  ...
  test("Lukuarvo with invalid input parameters") {
    val funktiokutsu = Funktiokutsu(
      nimi = Funktionimi.LUKUARVO,
      syoteparametrit = List(Syoteparametri(avain = "luku", arvo = "merkkijono"))
    )
    ...
    assert(1 == validationMessages.size)
    assert(
      Virhetyyppi.VIRHEELLINEN_SYOTEPARAMETRIN_TYYPPI ==
        validationMessages.get(0).asInstanceOf[Validointivirhe].getVirhetyyppi
    )
  }
  ...
  test("Valid lukuarvo") {
    val validationMessages =
      Laskentakaavavalidaattori.validoiLaskettavaKaava(validiLukuarvo1).getValidointivirheet
  ...
  test("Totuusarvo with incorrect input parameters") {
    val funktiokutsu = Funktiokutsu(
      nimi = Funktionimi.TOTUUSARVO,
      syoteparametrit = List(Syoteparametri(avain = "plop", arvo = "false"))
    )
  ...
  test("Totuusarvo with invalid input parameters") {
    val funktiokutsu = Funktiokutsu(
      nimi = Funktionimi.TOTUUSARVO,
      syoteparametrit = List(Syoteparametri(avain = "totuusarvo", arvo = "tosi"))
    )
  ...
  test("KonvertoiLukuarvo without konvertteri") {
    val funktiokutsu =
      Funktiokutsu(nimi = Funktionimi.KONVERTOILUKUARVO, funktioargumentit = List(validiLukuarvo2))
  ...
  test("Valid haeTotuusarvo") {
    val funktiokutsu = Funktiokutsu(
      ...
      valintaperustetunniste =
        List(ValintaperusteViite(onPakollinen = true, tunniste = "onYlioppilas"))
    )
  ...
  test("HaeLukuarvo with invalid oletusarvo") {
    val funktiokutsu = Funktiokutsu(
      ...
      valintaperustetunniste =
        List(ValintaperusteViite(onPakollinen = true, tunniste = "paasykoepisteet")),
      syoteparametrit = List(Syoteparametri(avain = "oletusarvo", arvo = "kuuppa"))
    )
  ...
  test("HaeLukuarvo with valid oletusarvo") {
    val funktiokutsu = Funktiokutsu(
      ...
      valintaperustetunniste =
        List(ValintaperusteViite(onPakollinen = true, tunniste = "paasykoepisteet")),
      syoteparametrit = List(Syoteparametri(avain = "oletusarvo", arvo = "10.0"))
    )
  ...
  test("HaeTotuusarvo with invalid oletusarvo") {
    val funktiokutsu = Funktiokutsu(
      ...
      valintaperustetunniste =
        List(ValintaperusteViite(onPakollinen = true, tunniste = "onYlioppilas")),
      syoteparametrit = List(Syoteparametri(avain = "oletusarvo", arvo = "tosi"))
    )
  ...
  test("HaeMerkkijonoJaKonvertoiLukuarvoksi with invalid oletusarvo") {
    val funktiokutsu = Funktiokutsu(
      ...
      valintaperustetunniste =
        List(ValintaperusteViite(onPakollinen = true, tunniste = "onYlioppilas")),
      syoteparametrit = List(Syoteparametri(avain = "oletusarvo", arvo = "kymmenen")),
      arvokonvertterit = List(
        Arvokonvertteriparametri(
          paluuarvo = "10.0",
          arvo = "L",
  ...
  test("HaeMerkkijonoJaKonvertoiTotuusarvoksi with invalid oletusarvo") {
    val funktiokutsu = Funktiokutsu(
      ...
      syoteparametrit = List(Syoteparametri(avain = "oletusarvo", arvo = "puuppa")),
      arvokonvertterit = List(
        Arvokonvertteriparametri(
          paluuarvo = "true",
          arvo = "L",
  ...
  test("Summa with invalid lukuarvo") {
    val funktiokutsu = Funktiokutsu(
      ...
      funktioargumentit = List(
        ...
        Funktiokutsu(
          nimi = Funktionimi.LUKUARVO,
          syoteparametrit = List(Syoteparametri(avain = "luku", arvo = "kolmekymmenta"))
        )
      )
    )
  ...
  test("Funktiokutsu with laskentakaava argument") {
      ...
      funktioargumentit = List(
        ...
        Laskentakaava(
          funktiokutsu = Funktiokutsu(
            nimi = Funktionimi.LUKUARVO,
            syoteparametrit = List(Syoteparametri(avain = "luku", arvo = "5.0"))
          ),
          nimi = "laskentakaava",
          onLuonnos = false
        )
    ...
    val validationMessages2 =
      Laskentakaavavalidaattori.validoiMallinnettuKaava(funktiokutsu).getValidointivirheet
...
//      validationMessages2.get(0).asInstanceOf[Validointivirhe].getVirhetyyppi)
  ...
  test("KeskiarvoNParasta with n less than 1") {
    val funktiokutsu = Funktiokutsu(
      ...
      funktioargumentit = List(validiLukuarvo1, validiLukuarvo2),
      syoteparametrit = List(Syoteparametri(avain = "n", arvo = "0"))
    )
    ...
    assert(1 == validationMessages.size())
    assert(
      Virhetyyppi.N_PIENEMPI_KUIN_YKSI == validationMessages
        .get(0)
        .asInstanceOf[Validointivirhe]
        .getVirhetyyppi
    )
  }
  ...
  test("Hae merkkijono ja vertaa yhtasuuruus, vertailtava puuttuu") {
    val funktiokutsu = Funktiokutsu(
      ...
      valintaperustetunniste =
        List(ValintaperusteViite(onPakollinen = true, tunniste = "aidinkieli")),
  ...
  test("painotettu keskiarvo, liian vahan argumentteja") {
    ...
    assert(validationMessages.size == 1)
    assert(
      Virhetyyppi.VAARA_MAARA_FUNKTIOARGUMENTTEJA == validationMessages
        .get(0)
        .asInstanceOf[Validointivirhe]
        .getVirhetyyppi
    )
  ...
  test("painotettu keskiarvo, ei argumentteja") {
    val funktiokutsu = Funktiokutsu(nimi = Funktionimi.PAINOTETTUKESKIARVO)
  ...
  test("valintaperusteyhtasuuruus, yksi valintaperusteviite") {
    ...
    assert(validationMessages.size == 1)
    assert(
      Virhetyyppi.VALINTAPERUSTEPARAMETRI_PUUTTUUU == validationMessages
        .get(0)
        .asInstanceOf[Validointivirhe]
        .getVirhetyyppi
    )
